...
SET(MSFRAMEWORK_INCLUDE_DIR ${MSFRAMEWORK_ROOT_DIR}/include)
    ...
    FIND_LIBRARY(MSREPORTING_LIBRARIES
      NAMES
          msReporting
      PATHS
        ${MSFRAMEWORK_ROOT_DIR}/lib/
    )
    FIND_LIBRARY(MSSTREAM_LIBRARIES
      NAMES
            msStream
      PATHS
        ${MSFRAMEWORK_ROOT_DIR}/lib/
    )
    FIND_LIBRARY(MSTHREADING_LIBRARIES
      NAMES
            msThreading
      PATHS
        ${MSFRAMEWORK_ROOT_DIR}/lib/
  ...
  MARK_AS_ADVANCED(MSREPORTING_LIBRARIES MSSTREAM_LIBRARIES MSTHREADING_LIBRARIES)
  SET(MSFRAMEWORK_LIBRARIES ${MSREPORTING_LIBRARIES} ${MSSTREAM_LIBRARIES} ${MSTHREADING_LIBRARIES})
