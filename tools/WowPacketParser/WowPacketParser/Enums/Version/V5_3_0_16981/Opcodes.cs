...
namespace WowPacketParser.Enums.Version.V5_3_0_16981
{
    public static class Opcodes_5_3_0
    {
        ...
        private static readonly BiDictionary<Opcode, int> Opcs = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_CHAR_ENUM, 403},
            {Opcode.CMSG_READY_FOR_ACCOUNT_DATA_TIMES, 6670},
            {Opcode.SMSG_REALM_SPLIT, 153},
            {Opcode.SMSG_AUTH_CHALLENGE, 362},
            {Opcode.CMSG_REALM_SPLIT, 4767},
            {Opcode.SMSG_ADDON_INFO, 296},
            {Opcode.CMSG_REQUEST_HOTFIX, 6795},
            {Opcode.SMSG_GUILD_QUERY_RESPONSE, 3394},
            {Opcode.SMSG_MOTD, 2090},
            {Opcode.SMSG_CREATURE_QUERY_RESPONSE, 436},
            {Opcode.SMSG_GAMEOBJECT_QUERY_RESPONSE, 21},
            {Opcode.SMSG_MESSAGECHAT, 2351},
            {Opcode.SMSG_ATTACKSTOP, 1295},
            {Opcode.SMSG_ATTACKSTART, 11},
            {Opcode.SMSG_LEVELUP_INFO, 1026},
            {Opcode.SMSG_UPDATE_TALENT_DATA, 2340},
            {Opcode.CMSG_LEARN_TALENTS, 6401},
            {Opcode.SMSG_LEARNED_SPELL, 2096},
            {Opcode.SMSG_BINDPOINTUPDATE, 1028},
            {Opcode.SMSG_ACTION_BUTTONS, 150},
            {Opcode.SMSG_SUPERCEDED_SPELL, 279},
            {Opcode.SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR, 385},
            {Opcode.SMSG_INITIALIZE_FACTIONS, 2319},
            {Opcode.SMSG_SPELLNONMELEEDAMAGELOG, 4229},
            {Opcode.SMSG_CANCEL_COMBAT, 1166},
            {Opcode.SMSG_LOG_XPGAIN, 1186},
            {Opcode.SMSG_PET_NAME_QUERY_RESPONSE, 1441},
            {Opcode.CMSG_PET_NAME_QUERY, 5160},
            {Opcode.CMSG_PET_ACTION, 5922},
            {Opcode.CMSG_GROUP_INVITE, 4638},
            {Opcode.SMSG_PARTY_COMMAND_RESULT, 5797},
            {Opcode.SMSG_GROUP_INVITE, 28},
            {Opcode.SMSG_PARTY_UPDATE, 317},
            {Opcode.CMSG_GROUP_INVITE_RESPONSE, 6922},
            {Opcode.SMSG_DUEL_REQUESTED, 4763},
            {Opcode.SMSG_INSPECT_TALENT, 2305},
            {Opcode.SMSG_TRADE_STATUS_EXTENDED, 2322},
            {Opcode.SMSG_SET_FORCED_REACTIONS, 152},
            {Opcode.SMSG_INIT_CURRENCY, 1172},
            {Opcode.SMSG_SET_EQUIPMENT_LIST, 2360},
            {Opcode.SMSG_DUMP_OBJECTS_DATA, 1422},
            {Opcode.CMSG_EQUIPMENT_SET_USE, 100},
            {Opcode.SMSG_LOAD_CUF_PROFILES, 157},
            {Opcode.SMSG_ACHIEVEMENT_EARNED, 1460},
            {Opcode.CMSG_USE_ITEM, 5288},
            {Opcode.SMSG_WHO, 2213},
            {Opcode.SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED, 1126},
            {Opcode.SMSG_LF_GUILD_BROWSE_UPDATED, 3163},
            ...
            {Opcode.SMSG_LIST_INVENTORY, 2189},
            {Opcode.CMSG_BUY_ITEM_IN_SLOT, 5731},
            {Opcode.SMSG_BUY_ITEM, 1448},
            {Opcode.SMSG_UNK_GUILD, 3139},
            {Opcode.SMSG_GUILD_CHALLENGE_UPDATED, 1355},
            {Opcode.SMSG_CALENDAR_SEND_CALENDAR, 32},
            {Opcode.SMSG_PLAYER_TABAR_VENDOR_ACTIVATE, 316},
            {Opcode.SMSG_GUILD_NEWS_UPDATE, 1358},
            {Opcode.SMSG_GUILD_RECIPES, 1135},
            {Opcode.SMSG_TRAINER_LIST, 154},
            {Opcode.SMSG_REFORGE_RESULT, 2180},
            {Opcode.CMSG_GET_MAIL_LIST, 6843},
            {Opcode.SMSG_MAIL_LIST_RESULT, 2188},
            {Opcode.SMSG_START_MIRROR_TIMER, 1076},
            {Opcode.SMSG_START_TIMER, 2361},
            {Opcode.SMSG_TEXT_EMOTE, 59},
            {Opcode.SMSG_SEND_MAIL_RESULT, 2094},
            {Opcode.CMSG_MAIL_TAKE_ITEM, 6967},
            {Opcode.SMSG_CRITERIA_UPDATE, 1335},
            {Opcode.SMSG_MOVE_SET_COLLISION_HEIGHT, 4710},
            {Opcode.CMSG_ACTIVATETAXIEXPRESS, 5998},
            {Opcode.SMSG_SET_FACTION_STANDING, 1214},
            {Opcode.SMSG_ACTIVATE_TAXI_REPLY, 281},
            {Opcode.SMSG_TOTEM_CREATED, 2308},
            {Opcode.SMSG_THREAT_REMOVE, 443},
            {Opcode.SMSG_SPELL_FAILED_OTHER, 442},
            {Opcode.SMSG_RESURRECT_REQUEST, 1297},
            {Opcode.SMSG_RAID_INSTANCE_MESSAGE, 1055},
            {Opcode.SMSG_PLAY_SPELL_VISUAL_KIT, 421},
            {Opcode.SMSG_PLAY_SPELL_VISUAL, 2048},
            {Opcode.SMSG_CLEAR_COOLDOWN, 1444},
            {Opcode.SMSG_SUSPEND_TOKEN_RESPONSE, 1058},
            {Opcode.SMSG_LOOT_REMOVED, 1446},
            {Opcode.SMSG_SOCKET_GEMS, 285},
            {Opcode.SMSG_ENCHANTMENTLOG, 2338},
            {Opcode.SMSG_ITEM_ENCHANT_TIME_UPDATE, 1079},
            {Opcode.SMSG_QUERY_TIME_RESPONSE, 139},
            {Opcode.SMSG_BATTLEPET_JOURNAL, 1461},
            {Opcode.SMSG_PERIODICAURALOG, 4247},
            {Opcode.SMSG_SPELLHEALLOG, 5524},
            ...
            {Opcode.SMSG_PETITION_QUERY_RESPONSE, 3508},
            {Opcode.SMSG_REQUEST_CEMETERY_LIST_RESPONSE, 1177},
            {Opcode.SMSG_ENVIRONMENTALDAMAGELOG, 5553},
            {Opcode.SMSG_SET_PROFICIENCY, 2337},
            {Opcode.CMSG_CHAR_FACTION_CHANGE, 6022},
            {Opcode.SMSG_CHAR_FACTION_CHANGE, 6024},
            {Opcode.SMSG_ITEM_REFUND_INFO_RESPONSE, 2108},
            {Opcode.SMSG_UPDATE_CURRENCY, 180},
            {Opcode.SMSG_SELL_ITEM, 309},
            {Opcode.SMSG_PAGE_TEXT_QUERY_RESPONSE, 276},
            {Opcode.SMSG_COIN_REMOVED, 3},
            {Opcode.SMSG_LOSS_OF_CONTROL_AURA_UPDATE, 2083},
            {Opcode.SMSG_GUILD_PARTY_STATE_RESPONSE, 3187},
            {Opcode.SMSG_ROLE_CHANGED_INFORM, 2187},
            {Opcode.SMSG_SPELLBREAKLOG, 6528},
            {Opcode.SMSG_SPELL_COOLDOWN, 1695},
            {Opcode.SMSG_SET_PCT_SPELL_MODIFIER, 7174},
            {Opcode.SMSG_SET_FLAT_SPELL_MODIFIER, 5424},
            {Opcode.CMSG_SET_SELECTION, 7030},
            {Opcode.SMSG_BATTLEFIELD_STATUS_NEED_CONFIRMATION, 1287},
            {Opcode.SMSG_BATTLEFIELD_STATUS_QUEUED, 269},
            {Opcode.SMSG_BATTLEFIELD_STATUS, 1436},
            {Opcode.SMSG_GUILD_PERMISSIONS_QUERY_RESULTS, 1090},
            {Opcode.SMSG_BATTLEGROUND_PLAYER_POSITIONS, 2104}
