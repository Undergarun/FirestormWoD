...
const struct RewriteItem Win32Patchs[] = {
   ...
   // { 0x038BC49, sizeof(win32_packet_sending_routage),              win32_packet_sending_routage                },   ///< Don't use special routage for packets
    { 0x0A2E5EC, sizeof(config_data),                               config_data                                 },   ///< Change default configuration file
    { 0x0A523C4, sizeof(builddate_data),                            builddate_data                              },   ///< Change build date
    { 0x0AF166C, sizeof(bnet_portal_data),                          bnet_portal_data                            },   ///< Change bnet portal
};
