...
DELETE FROM `areatrigger_template` WHERE spell_id IN (171545, 158602, 158707);
...
DELETE FROM spell_script_names WHERE spell_id IN (158078, 164271, 164279, 156214, 158315, 158009, 156601, 158148);
