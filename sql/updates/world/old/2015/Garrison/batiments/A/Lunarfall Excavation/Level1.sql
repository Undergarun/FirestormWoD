INSERT INTO npc_text (`ID`, `text0_0`, `text0_1`, `lang0`, `prob0`, `WDBVerified`) VALUES(87264, "Draenic stone can be mined from mining deposits across draenor.  Return to me once you have 5 or more and I will refine them into ore for you.", "Draenic stone can be mined from mining deposits across draenor.  Return to me once you have 5 or more and I will refine them into ore for you.", 0, 100, 19342) ON DUPLICATE KEY UPDATE `ID` = VALUES(`ID`), `text0_0` = VALUES(`text0_0`), `text0_1` = VALUES(`text0_1`), `lang0` = VALUES(`lang0`), `prob0` = VALUES(`prob0`), `WDBVerified` = VALUES(`WDBVerified`);
UPDATE creature_template SET ScriptName="npc_TimothyLeens_Garr", npcFlag=1, npcFlag2=32 WHERE entry = 77730;
