...
UPDATE creature_template SET dmg_multiplier = 5, ScriptName = 'npc_highmaul_night_twisted_berserker' WHERE entry = 80822;
UPDATE creature_template SET dmg_multiplier = 5, ScriptName = 'npc_highmaul_night_twisted_earthwarper' WHERE entry = 80599;
