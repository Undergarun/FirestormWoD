...
DELETE FROM spell_script_names WHERE spell_id IN (156345, 158424, 160379, 155192, 174716, 156934, 158247, 155176, 158345, 176121, 155225, 155179, 155288);
...
DELETE FROM conditions WHERE SourceEntry IN (155180, 155188, 155265, 155239, 177434, 155179);
