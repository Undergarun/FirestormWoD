...
DELETE FROM spell_script_names WHERE spell_id IN (162653, 161300, 155365);
INSERT INTO spell_script_names VALUES
(162653, "spell_foundry_electrical_storm"),
(161300, "spell_foundry_hitching_post_chain"),
(155365, "spell_foundry_pin_down_searcher");

DELETE FROM areatrigger_template WHERE spell_id IN (162657, 162757);
...
DELETE FROM creature_text WHERE entry IN (80400, 80409, @REF_DARMAC);
...
(@REF_DARMAC, 1, 0, "Aid me!", 14, 0, 100, 0, 0, 41956, "MountingCruelfang"),
...
DELETE FROM locales_creature_text WHERE entry IN (80400, 80409, @REF_DARMAC);
