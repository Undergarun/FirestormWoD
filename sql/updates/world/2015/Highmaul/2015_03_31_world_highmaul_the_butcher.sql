...
UPDATE creature_template SET minlevel = 103, maxlevel = 103, unit_flags = unit_flags & ~0x00200000, unit_class = 4, dmg_multiplier = 10, ScriptName = 'boss_the_butcher', mechanic_immune_mask = 617299839, flags_extra = 0x01 WHERE entry = 77404;
