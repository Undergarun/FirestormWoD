...
UPDATE creature_template SET ScriptName = 'npc_ashran_korlok' WHERE entry = 80858;
UPDATE creature_template SET ScriptName = 'npc_ashran_faction_champions' WHERE entry IN (81725, 81726);

DELETE FROM trinity_string WHERE entry IN (14063, 14064, 14065);
INSERT INTO trinity_string (entry, content_default, content_loc2, content_loc6) VALUES
(14063, '|cFF0000FF+$1i Slain |r', '|cFF0000FF+$1i victime(s) |r', '|cFF0000FF+$1i asesinado |r'),
(14064, '|c00FFFF00|Hspell:178380|h[Kor''lok, the ogre king]|h|r is awakening!', '|c00FFFF00|Hspell:178380|h[Kor''lok, le roi des ogres]|h|r se réveille !', '¡|c00FFFF00|Hspell:178380|h[Kor''lok, el roy ogro]|h|r está despertando!'),
(14065, 'The |c00FFFF00|Hspell:178380|h[Event: Kor''lok, the ogre king]|h|r begins at the Throne of Kor''lok in 3 minutes.', 'L''|c00FFFF00|Hspell:178380|h[Évènement : Kor''lok, le roi des ogres]|h|r commence au trône de Kor''lok dans 3 minutes.', 'El |c00FFFF00|Hspell:178380|h[Evento : Kor''lok, el roy ogro]|h|r comienzará en el Trono de Kor''lok en 3 minutos.');