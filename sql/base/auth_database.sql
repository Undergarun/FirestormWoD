...
# Created: March 31, 2015 at 3:01:44 PM CST
...
) ENGINE=InnoDB AUTO_INCREMENT=234919 DEFAULT CHARSET=utf8 COMMENT='Account System';
...
CREATE TABLE `account_battlepet` (
  ...
  PRIMARY KEY (`id`),
  KEY `account` (`account`)
) ENGINE=InnoDB AUTO_INCREMENT=207152 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='Realm System';
