...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9502159 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
/*Table structure for table `creature_template_difficulty_bab` */
...
/*Table structure for table `creature_template_mop` */
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2133 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
) ENGINE=MyISAM AUTO_INCREMENT=8897585 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
...
/*Table structure for table `gameobject_origin_copy` */
...
/*Table structure for table `map_challenge_mode_hotfixes` */
