...
SpellEffectInfo::StaticData  SpellEffectInfo::_data[TOTAL_SPELL_EFFECTS] =
{
    ...
    {EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_UNIT},          //< 177 SPELL_EFFECT_DESPAWN_AREA_TRIGGER
    ...
    {EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_UNIT},          //< 182 SPELL_EFFECT_DESPAWN_AREA_TRIGGER_2
