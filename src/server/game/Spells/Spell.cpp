...
void Spell::_handle_finish_phase()
{
    if (m_caster->m_movedPlayer)
    {
        ...
        if (m_needComboPoints || m_spellInfo->Id == 127538)
        {
            ...
            if (m_caster->HasAura(115189) && (m_spellInfo->Id == 408 || m_spellInfo->Id == 1943 || m_spellInfo->Id == 2098 || m_spellInfo->Id == 32645 || m_spellInfo->Id == 121411 || m_spellInfo->Id == 152150))
            {
