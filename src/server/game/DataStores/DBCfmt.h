...
const char AreaTableEntryfmt[]                = "iiiiiiiiiisiisiiiiiffiiiiiiiii";
const char AreaGroupEntryfmt[]                = "niiiiiii";
const char AreaPOIEntryfmt[]                  = "niiiiiiiiiiiffiiissiiii";
const char AreaTriggerEntryfmt[]              = "nifffiiifffffiii";
...
const char SpellPowerEntryfmt[]               = "nixiiiixxffif";
const char SpellInterruptsEntryfmt[]          = "dixiiiii";
...
const char SpellShapeshiftEntryfmt[]          = "niiiix";
