...
const char ChrSpecializationsfmt[]            = "nsiixixixxxsxsxi";
...
const char MapEntryfmt[]                      = "nxixxxsixxixiffxiiiixx";
...
const char SpellInterruptsEntryfmt[]          = "diiiiiii";
const char SpellEquippedItemsEntryfmt[]       = "diiiii";
const char SpellAuraOptionsEntryfmt[]         = "niiiiiiii";
const char SpellCooldownsEntryfmt[]           = "diiiii";
const char SpellLevelsEntryfmt[]              = "diiiii";
