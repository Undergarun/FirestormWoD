...
const char TaxiNodesEntryfmt[] = "nifffsiiiiff";
const char TaxiPathEntryfmt[] = "niii";
const char TaxiPathNodeEntryfmt[] = "diiifffiiii";
const char SpellRuneCostfmt[] = "niiiii";
const char SpellCastingRequirementsEntryfmt[] = "diiiiii";
...
const char SpellPowerEntryfmt[] = "nixiiiiiiiffif";
const char SpellTotemsEntryfmt[] = "niiii";
const char SpellClassOptionsEntryfmt[] = "diiiiii";
