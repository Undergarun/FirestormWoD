...
#define sScriptMgr ACE_Singleton<MS::Game::Scripting::ScriptMgr, ACE_Null_Mutex>::instance()
...
namespace MS { namespace Game { namespace Scripting 
{
    ...
    class ScriptMgr
    {
        ...
        friend class Interfaces::ScriptObjectImpl<true>;
        friend class Interfaces::ScriptObjectImpl<false>;
        ...
        /// Interfaces::CommandScript
        public:
            /// Should return a pointer to a valid command table (ChatCommand array) to be used by ChatHandler.
            std::vector<ChatCommand*> GetChatCommands();

        /// Interfaces::WeatherScript
        public:
        ...
        /// Interfaces::DynamicObjectScript
        public:
            /// On update
            /// @p_Object : Updated object instance
            /// @p_Diff   : Time since last update
        ...
        public:
            ...
            /// Interfaces::AchievementCriteriaScript
        public:
        ...
        public:
            ...
            /// @p_SpellID      : Spell ID
            /// @p_ScriptVector :
            void CreateSpellScriptLoaders(uint32 p_SpellID, std::vector<std::pair<Interfaces::SpellScriptLoader*, std::multimap<uint32, uint32>::iterator>> & p_ScriptVector);

        /// Interfaces::TransportScript
        public:
