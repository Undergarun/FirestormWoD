...
_security(sec), m_PremiumType(premiumType), _ispremium(ispremium), _accountId(id), m_expansion(expansion), _logoutTime(0), m_VoteRemainingTime(p_VoteRemainingTime), m_VoteTimePassed(0), m_VoteSyncTimer(VOTE_SYNC_TIMER),
