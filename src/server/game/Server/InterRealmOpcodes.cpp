...
#define DEFINE_IR_OPCODE_HANDLER(opcode, handler) \
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_ACCOUNT_SPELLS,            &InterRealmClient::Handle_AccountSpells       );

    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_ANTICHEAT_REPORT,          &InterRealmClient::Handle_ServerSide    );

    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_CHARACTER_SKILLS,            &InterRealmClient::Handle_CharacterSkills       );
