...
enum Opcodes
{
    ...
    CMSG_ACCEPT_TRADE                                 = 0x000,  // 5.0.5 16048
    ...
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x000,  // 5.0.5 16048
    CMSG_AUCTION_PLACE_BID                            = 0x000,  // 5.0.5 16048
    CMSG_AUCTION_REMOVE_ITEM                          = 0x000,  // 5.0.5 16048
    CMSG_AUCTION_SELL_ITEM                            = 0x000,  // 5.0.5 16048
    ...
    CMSG_AUTO_DECLINE_GUILD_INVITES                   = 0x000,  // 5.0.5 16048
    CMSG_BANKER_ACTIVATE                              = 0x000,  // 5.0.5 16048
    CMSG_BATTLEFIELD_JOIN                             = 0x000,  // 5.0.5 16048
    CMSG_BATTLEFIELD_LEAVE                            = 0x000,  // 5.0.5 16048
    CMSG_BATTLEFIELD_LIST                             = 0x000,  // 5.0.5 16048
    ...
    CMSG_BATTLEFIELD_PORT                             = 0x000,  // 5.0.5 16048
    CMSG_BATTLEFIELD_REQUEST_SCORE_DATA               = 0x000,  // 5.0.5 16048
    CMSG_BATTLEFIELD_STATUS                           = 0x000,  // 5.0.5 16048
    CMSG_BATTLEGROUND_PLAYER_POSITIONS                = 0x000,  // 5.0.5 16048
    CMSG_BATTLEMASTER_JOIN                            = 0x000,  // 5.0.5 16048
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x000,  // 5.0.5 16048
    CMSG_BATTLEMASTER_JOIN_RATED                      = 0x000,  // 5.0.5 16048
    CMSG_BEGIN_TRADE                                  = 0x000,  // 5.0.5 16048
    CMSG_BINDER_ACTIVATE                              = 0x000,  // 5.0.5 16048
    CMSG_BOT_DETECTED2                                = 0x000,  // 5.0.5 16048
    CMSG_BUG                                          = 0x000,  // 5.0.5 16048
    CMSG_BUSY_TRADE                                   = 0x000,  // 5.0.5 16048
    CMSG_BUYBACK_ITEM                                 = 0x000,  // 5.0.5 16048
    CMSG_BUY_BANK_SLOT                                = 0x000,  // 5.0.5 16048
    CMSG_BUY_ITEM                                     = 0x000,  // 5.0.5 16048
    ...
    CMSG_CALENDAR_GET_CALENDAR                        = 0x000,  // 5.0.5 16048
    CMSG_CALENDAR_GET_EVENT                           = 0x000,  // 5.0.5 16048
    CMSG_CALENDAR_GET_NUM_PENDING                     = 0x000,  // 5.0.5 16048
    ...
    CMSG_CANCEL_TRADE                                 = 0x000,  // 5.0.5 16048
    ...
    CMSG_CHANNEL_ANNOUNCEMENTS                        = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_BAN                                  = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_DISPLAY_LIST                         = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_INVITE                               = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_KICK                                 = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_LIST                                 = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_MODERATOR                            = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_MUTE                                 = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_OWNER                                = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_PASSWORD                             = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_SET_OWNER                            = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_SILENCE_ALL                          = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_SILENCE_VOICE                        = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_UNBAN                                = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_UNMODERATOR                          = 0x000,  // 5.0.5 16048
    CMSG_CHANNEL_UNMUTE                               = 0x000,  // 5.0.5 16048
    ...
    CMSG_CHAR_CREATE                                  = 0x17CF, // 5.4.0 17371
    CMSG_CHAR_CUSTOMIZE                               = 0x000,  // 5.0.5 16048
    CMSG_CHAR_DELETE                                  = 0x1783, // 5.4.0 17371
    CMSG_CHAR_ENUM                                    = 0x1B9E, // 5.4.0 17371
    CMSG_CHAR_FACTION_CHANGE                          = 0x000,  // 5.0.5 16048
    CMSG_CHAR_RACE_CHANGE                             = 0x000,  // 5.0.5 16048
    CMSG_CHAR_RENAME                                  = 0x000,  // 5.0.5 16048
    ...
    CMSG_CLEAR_TRADE_ITEM                             = 0x000,  // 5.0.5 16048
    ...
    CMSG_COMPLAIN                                     = 0x000,  // 5.0.5 16048
    CMSG_COMPLETE_CINEMATIC                           = 0x000,  // 5.0.5 16048
    ...
    CMSG_CREATURE_QUERY                               = 0x1585, // 5.4.0 17371
    ...
    CMSG_GAMEOBJECT_REPORT_USE                        = 0x000,  // 5.0.5 16048 0x1367 or 0x1B36
    CMSG_GAMEOBJECT_USE                               = 0x000,  // 5.0.5 16048 0x1367 or 0x1B36
    CMSG_GAMESPEED_SET                                = 0x000,  // 5.0.5 16048
    CMSG_GAMETIME_SET                                 = 0x000,  // 5.0.5 16048
    CMSG_GETDEATHBINDZONE                             = 0x000,  // 5.0.5 16048
    CMSG_GET_MAIL_LIST                                = 0x000,  // 5.0.5 16048
    ...
    CMSG_GOSSIP_HELLO                                 = 0x000,  // 5.4.0 17399 0x1A3F?
    ...
    CMSG_GROUP_DISBAND                                = 0x000,  // 5.0.5 16048
    CMSG_GROUP_INVITE                                 = 0x000,  // 5.0.5 16048
    CMSG_GROUP_INVITE_RESPONSE                        = 0x000,  // 5.0.5 16048
    ...
    CMSG_GUILD_ADD_RANK                               = 0x000,  // 5.0.5 16048
    CMSG_GUILD_ASSIGN_MEMBER_RANK                     = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANKER_ACTIVATE                        = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_BUY_TAB                           = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_DEPOSIT_MONEY                     = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_LOG_QUERY                         = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY             = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_NOTE                              = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_QUERY_TAB                         = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_QUERY_TEXT                        = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_SWAP_ITEMS                        = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x000,  // 5.0.5 16048
    CMSG_GUILD_BANK_WITHDRAW_MONEY                    = 0x000,  // 5.0.5 16048
    CMSG_GUILD_CHANGE_NAME_REQUEST                    = 0x000,  // 5.0.5 16048
    CMSG_GUILD_DECLINE                                = 0x000,  // 5.0.5 16048
    CMSG_GUILD_DEL_RANK                               = 0x000,  // 5.0.5 16048
    CMSG_GUILD_CHANGE_NAME_RANK                       = 0x000,  // 5.0.5 16048
    ...
    CMSG_GUILD_SET_RANK_PERMISSIONS                   = 0x000,  // 5.0.5 16048
    CMSG_GUILD_SWITCH_RANK                            = 0x000,  // 5.0.5 16048
    CMSG_HEARTH_AND_RESURRECT                         = 0x000,  // 5.0.5 16048
    CMSG_IGNORE_TRADE                                 = 0x000,  // 5.0.5 16048 Deprecated ?
    CMSG_INITIATE_TRADE                               = 0x000,  // 5.0.5 16048
    CMSG_INSPECT                                      = 0x000,  // 5.0.5 16048
    CMSG_INSPECT_HONOR_STATS                          = 0x000,  // 5.0.5 16048
    ...
    CMSG_JOIN_CHANNEL                                 = 0x000,  // 5.0.5 16048
    CMSG_KEEP_ALIVE                                   = 0x000,  // 5.0.5 16048
    CMSG_LEARN_PET_SPECIALIZATION_GROUP               = 0x000,  // 5.0.5 16048
    CMSG_LEARN_TALENTS                                = 0x000,  // 5.0.5 16048
    CMSG_LEAVE_BATTLEFIELD                            = 0x000,  // 5.0.5 16048
    CMSG_LEAVE_CHANNEL                                = 0x000,  // 5.0.5 16048
    CMSG_LFG_GET_PLAYER_INFO                          = 0x000,  // 5.0.5 16048
    CMSG_LFG_GET_STATUS                               = 0x000,  // 5.0.5 16048
    CMSG_LFG_JOIN                                     = 0x000,  // 5.0.5 16048
    CMSG_LFG_LEAVE                                    = 0x000,  // 5.0.5 16048
    CMSG_LFG_PARTY_LOCK_INFO_REQUEST                  = 0x000,  // 5.0.5 16048
    CMSG_LFG_PROPOSAL_RESULT                          = 0x000,  // 5.0.5 16048
    CMSG_LFG_SET_BOOT_VOTE                            = 0x000,  // 5.0.5 16048
    ...
    CMSG_LOAD_SCREEN                                  = 0x160B, // 5.4.0 17371
    CMSG_LOGOUT_CANCEL                                = 0x000,  // 5.0.5 16048
    CMSG_LOGOUT_REQUEST                               = 0x16E7, // 5.4.0 17371
    CMSG_LOG_DISCONNECT                               = 0x380,  // 5.4.0 17371
    CMSG_LOOT                                         = 0x000,  // 5.0.5 16048
    CMSG_LOOT_CURRENCY                                = 0x000,  // 5.0.5 16048
    CMSG_LOOT_MASTER_GIVE                             = 0x000,  // 5.0.5 16048
    CMSG_LOOT_METHOD                                  = 0x000,  // 5.0.5 16048
    CMSG_LOOT_MONEY                                   = 0x000,  // 5.0.5 16048
    CMSG_LOOT_RELEASE                                 = 0x000,  // 5.0.5 16048
    CMSG_LOOT_ROLL                                    = 0x000,  // 5.0.5 16048
    CMSG_LOOT_MASTER_ASK_FOR_ROLL                     = 0x000,  // 5.0.5 16048
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x000,  // 5.0.5 16048
    CMSG_MAIL_DELETE                                  = 0x000,  // 5.0.5 16048
    CMSG_MAIL_MARK_AS_READ                            = 0x000,  // 5.0.5 16048
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x000,  // 5.0.5 16048
    CMSG_MAIL_TAKE_ITEM                               = 0x000,  // 5.0.5 16048
    CMSG_MAIL_TAKE_MONEY                              = 0x000,  // 5.0.5 16048
    ...
    CMSG_MESSAGECHAT_BATTLEGROUND                     = 0x000,  // 5.0.5 16048
    ...
    CMSG_MESSAGECHAT_RAID_WARNING                     = 0x000,  // 5.0.5 16048
    ...
    CMSG_PETITION_BUY                                 = 0x000,  // 5.0.5 16048
    CMSG_PETITION_QUERY                               = 0x000,  // 5.0.5 16048
    CMSG_PETITION_SHOWLIST                            = 0x000,  // 5.0.5 16048
    CMSG_PETITION_SHOW_SIGNATURES                     = 0x000,  // 5.0.5 16048
    CMSG_PETITION_SIGN                                = 0x000,  // 5.0.5 16048
    CMSG_PET_ABANDON                                  = 0x000,  // 5.0.5 16048
    CMSG_PET_ACTION                                   = 0x000,  // 5.0.5 16048
    CMSG_PET_CANCEL_AURA                              = 0x000,  // 5.0.5 16048
    CMSG_PET_CAST_SPELL                               = 0x000,  // 5.0.5 16048
    CMSG_PET_NAME_QUERY                               = 0x000,  // 5.0.5 16048
    CMSG_PET_RENAME                                   = 0x000,  // 5.0.5 16048
    CMSG_PET_SET_ACTION                               = 0x000,  // 5.0.5 16048
    CMSG_PET_SPELL_AUTOCAST                           = 0x000,  // Deprecated in 5.0.5 16048
    CMSG_PET_STOP_ATTACK                              = 0x000,  // 5.0.5 16048
    CMSG_PING                                         = 0x0784, // 5.4.0 17371
    CMSG_PLAYED_TIME                                  = 0x000,  // 5.0.5 16048
    CMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x000,  // 5.0.5 16048
    CMSG_PLAYER_LOGIN                                 = 0x1BC7, // 5.4.0 17371
    CMSG_PLAYER_LOGOUT                                = 0x000,  // 5.0.5 16048
    CMSG_PLAYER_VEHICLE_ENTER                         = 0x000,  // 5.0.5 16048
    CMSG_PLAY_DANCE                                   = 0x000,  // 5.0.5 16048
    CMSG_PUSHQUESTTOPARTY                             = 0x000,  // 5.0.5 16048
    CMSG_PVP_LOG_DATA                                 = 0x000,  // 5.0.5 16048
    ...
    CMSG_REQUEST_HOTFIX                               = 0x1A8B,	// 5.4.0 17371
    CMSG_REQUEST_INSPECT_RATED_BG_STATS               = 0x000,  // 5.0.5 16048
    ...
    CMSG_SELECT_FACTION                               = 0x000,  // 5.0.5 16048
    CMSG_SELF_RES                                     = 0x000,  // 5.0.5 16048
    CMSG_SELL_ITEM                                    = 0x000,  // 5.0.5 16048
    CMSG_SEND_MAIL                                    = 0x000,  // 5.0.5 16048
    CMSG_SEND_SOR_REQUEST_VIA_ADDRESS                 = 0x000,  // 5.0.5 16048
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x000,  // 5.0.5 16048
    ...
    CMSG_SET_EVERYONE_IS_ASSISTANT                    = 0x000,  // 5.0.5 16048
    CMSG_SET_FACTION_ATWAR                            = 0x000,  // 5.0.5 16048
    CMSG_SET_FACTION_CHEAT                            = 0x000,  // 5.0.5 16048
    CMSG_SET_FACTION_INACTIVE                         = 0x000,  // 5.0.5 16048
    CMSG_SET_GUILD_BANK_TEXT                          = 0x000,  // 5.0.5 16048
    ...
    CMSG_SET_SPECIALIZATION                           = 0x000,  // 5.0.5 16048
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x000,  // 5.0.5 16048
    CMSG_SET_TITLE                                    = 0x000,  // 5.0.5 16048
    CMSG_SET_TRADE_CURRENCY                           = 0x000,  // 5.0.5 16048
    CMSG_SET_TRADE_GOLD                               = 0x000,  // 5.0.5 16048
    CMSG_SET_TRADE_ITEM                               = 0x000,  // 5.0.5 16048
    CMSG_SET_VEHICLE_REC_ID_ACK                       = 0x000,  // 5.0.5 16048
    CMSG_SET_WATCHED_FACTION                          = 0x000,  // 5.0.5 16048
    CMSG_SHOWING_CLOAK                                = 0x000,  // 5.0.5 16048
    CMSG_SHOWING_HELM                                 = 0x000,  // 5.0.5 16048
    ...
    CMSG_TUTORIAL_FLAG                                = 0x000,  // 5.0.5 16048
    CMSG_TUTORIAL_RESET                               = 0x000,  // 5.0.5 16048
    CMSG_UNACCEPT_TRADE                               = 0x000,  // 5.0.5 16048
    CMSG_UNLEARN_SKILL                                = 0x000,  // 5.0.5 16048
    ...
    CMSG_VIOLENCE_LEVEL                               = 0x1927, // 5.4.0 17371
    CMSG_VOICE_SESSION_ENABLE                         = 0x000,  // 5.0.5 16048
    CMSG_VOID_STORAGE_QUERY                           = 0x000,  // 5.0.5 16048
    CMSG_VOID_STORAGE_TRANSFER                        = 0x000,  // 5.0.5 16048
    CMSG_VOID_STORAGE_UNLOCK                          = 0x000,  // 5.0.5 16048
    CMSG_VOID_SWAP_ITEM                               = 0x000,  // 5.0.5 16048
    CMSG_WARDEN_DATA                                  = 0x1702, // 5.4.0 17371
    ...
    MSG_LIST_STABLED_PETS                             = 0x000,  // 5.0.5 16048
    ...
    MSG_MOVE_TELEPORT                                 = 0,      // Client patched
    MSG_MOVE_TELEPORT_ACK                             = 0,      // Client patched
    ...
    MSG_RANDOM_ROLL                                   = 0x000,  // 5.0.5 16048
    ...
    MSG_VERIFY_CONNECTIVITY                           = 0x4F57, // 5.4.0 17371

    // SMSG
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x82C,  // 5.4.0 17371
    SMSG_ACCOUNT_DATA_TIMES                           = 0x890,  // 5.4.0 17371
    SMSG_ACCOUNT_INFO_RESPONSE                        = 0x000,  // 5.0.5 16048
    SMSG_ACCOUNT_RESTRICTED_WARNING                   = 0x002D, // 5.4.0 17399 (JamList)
    SMSG_ACHIEVEMENT_DELETED                          = 0x000,  // 5.0.5 16048
    SMSG_ACHIEVEMENT_EARNED                           = 0x000,  // 5.0.5 16048
    SMSG_ACTION_BUTTONS                               = 0x000,  // 5.0.5 16048
    SMSG_ACTIVATETAXIREPLY                            = 0x000,  // 5.0.5 16048
    SMSG_ADDON_INFO                                   = 0x128,  // 5.4.0 17371
    SMSG_ADD_RUNE_POWER                               = 0x000,  // 5.0.5 16048
    SMSG_AI_REACTION                                  = 0x000,  // 5.0.5 16048
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x000,  // 5.0.5 16048
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x000,  // 5.0.5 16048
    SMSG_AREA_TRIGGER_MESSAGE                         = 0x000,  // 5.0.5 16048
    SMSG_AREA_TRIGGER_MOVEMENT_UPDATE                 = 0x001D, // 5.4.0 17399 (JamList)
    SMSG_AREA_TRIGGER_RESET                           = 0x000,  // 5.0.5 16048
    SMSG_ARENA_ERROR                                  = 0x000,  // 5.0.5 16048
    ...
    SMSG_ATTACKSWING_NOTINRANGE                       = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_BIDDER_LIST_RESULT                   = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_BIDDER_NOTIFICATION                  = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_COMMAND_RESULT                       = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_LIST_PENDING_SALES                   = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_LIST_RESULT                          = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_OWNER_LIST_RESULT                    = 0x000,  // 5.0.5 16048
    SMSG_AUCTION_OWNER_NOTIFICATION                   = 0x002A, // 5.4.0 17399 (JamList)
    ...
    SMSG_AVERAGE_ITEM_LEVEL_INFORM                    = 0x053A, // 5.4.0 17399 (JamList)
    SMSG_BARBER_SHOP_RESULT                           = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_LIST                             = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_EJECTED                      = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING                = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_ENTERED                      = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                 = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                 = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE       = 0x0035, // 5.4.0 17399 (JamList)
    SMSG_BATTLEFIELD_MGR_STATE_CHANGED                = 0x002C, // 5.4.0 17399 (JamList)
    SMSG_BATTLEFIELD_PORT_DENIED                      = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_RATED_INFO                       = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS                           = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS_QUEUED                    = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION          = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS_ACTIVE                    = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS             = 0x000,  // 5.0.5 16048
    SMSG_BATTLEFIELD_STATUS_FAILED                    = 0x000,  // 5.0.5 16048
    SMSG_BATTLEGROUND_INFO_THROTTLED                  = 0x000,  // 5.0.5 16048
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x000,  // 5.0.5 16048
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x000,  // 5.0.5 16048
    SMSG_BATTLEGROUND_PLAYER_POSITIONS                = 0x000,  // 5.0.5 16048
    SMSG_BATTLEPET_JOURNAL                            = 0x000,  // 5.0.5 16048
    SMSG_BEASTMASTER_FAILED                           = 0x003A, // 5.4.0 17399 (JamList) (NYI)
    SMSG_BINDER_CONFIRM                               = 0x000,  // 5.0.5 16048
    SMSG_BINDPOINTUPDATE                              = 0x000,  // 5.0.5 16048
    SMSG_BINDZONEREPLY                                = 0x000,  // 5.0.5 16048
    SMSG_BLACKMARKET_ITEM_RESULT                      = 0x0481, // 5.4.0 17399 (JamList) @todo BlackMarket NYI
    SMSG_BLACKMARKET_BID_ON_ITEM_RESULT               = 0x092C, // 5.4.0 17399 (JamList) @todo BlackMArket NYI
    SMSG_BREAK_TARGET                                 = 0x000,  // 5.0.5 16048
    SMSG_BUY_BANK_SLOT_RESULT                         = 0x000,  // 5.0.5 16048
    SMSG_BUY_FAILED                                   = 0x000,  // 5.0.5 16048
    SMSG_BUY_ITEM                                     = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_ACTION_PENDING                      = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_ARENA_TEAM                          = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE                        = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE_ALERT                  = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE_NOTES                  = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT            = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE_REMOVED                = 0x0011, // 5.4.0 17399 (JamList)
    SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT          = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT           = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_MODERATOR_STATUS_ALERT        = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x0006, // 5.4.0 17399 (JamList)
    SMSG_CALENDAR_EVENT_STATUS                        = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x0086, // 5.4.0 17399 (JamList)
    SMSG_CALENDAR_FILTER_GUILD                        = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x0020, // 5.4.0 17399 (JamList)
    SMSG_CALENDAR_SEND_EVENT                          = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x000,  // 5.0.5 16048
    SMSG_CALENDAR_UPDATE_INVITE_LIST                  = 0x000,  // 5.0.5 16048
    SMSG_CAMERA_SHAKE                                 = 0x000,  // 5.0.5 16048
    SMSG_CANCEL_AUTO_REPEAT                           = 0x000,  // 5.0.5 16048
    SMSG_CANCEL_COMBAT                                = 0x000,  // 5.0.5 16048
    SMSG_CAST_FAILED                                  = 0x039,  // 5.4.0 17399
    SMSG_CHANNEL_LIST                                 = 0x000,  // 5.0.5 16048
    SMSG_CHANNEL_MEMBER_COUNT                         = 0x000,  // 5.0.5 16048
    SMSG_CHANNEL_NOTIFY                               = 0x000,  // 5.0.5 16048
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x000,  // 5.0.5 16048
    SMSG_CHAR_CREATE                                  = 0x914,  // 5.4.0 17371
    SMSG_CHAR_CUSTOMIZE                               = 0x000,  // 5.0.5 16048
    SMSG_CHAR_DELETE                                  = 0x806,  // 5.4.0 17371
    SMSG_CHAR_ENUM                                    = 0x193,  // 5.4.0 17371
    SMSG_CHAR_FACTION_CHANGE                          = 0x000,  // 5.0.5 16048
    SMSG_CHAR_RENAME                                  = 0x000,  // 5.0.5 16048
    SMSG_CHAT_IGNORED_ACCOUNT_MUTED                   = 0x000,  // 5.0.5 16048
    SMSG_CHAT_NOT_IN_PARTY                            = 0x000,  // 5.0.5 16048
    SMSG_CHAT_PLAYER_AMBIGUOUS                        = 0x000,  // 5.0.5 16048
    SMSG_CHAT_PLAYER_NOT_FOUND                        = 0x000,  // 5.0.5 16048
    SMSG_CHAT_RESTRICTED                              = 0x000,  // 5.0.5 16048
    SMSG_CHAT_SERVER_DISCONNECTED                     = 0x000,  // 5.0.5 16048
    SMSG_CHAT_SERVER_RECONNECTED                      = 0x000,  // 5.0.5 16048
    SMSG_CHAT_WRONG_FACTION                           = 0x000,  // 5.0.5 16048
    SMSG_CHECK_FOR_BOTS                               = 0x000,  // 5.0.5 16048
    SMSG_CLEAR_BOSS_EMOTES                            = 0x0009, // 5.4.0 17399 (JamList)
    SMSG_CLEAR_COOLDOWN                               = 0x000,  // 5.0.5 16048
    SMSG_CLEAR_COOLDOWNS                              = 0x000,  // 5.0.5 16048
    SMSG_CLEAR_FAR_SIGHT_IMMEDIATE                    = 0x000,  // 5.0.5 16048
    SMSG_CLEAR_TARGET                                 = 0x000,  // 5.0.5 16048
    SMSG_CLIENTCACHE_VERSION                          = 0x825,  // 5.4.0 17371
    SMSG_CLIENT_CONTROL_UPDATE                        = 0x000,  // 5.0.5 16048
    SMSG_COMBAT_EVENT_FAILED                          = 0x000,  // 5.0.5 16048
    SMSG_COMBAT_LOG_MULTIPLE                          = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_MAP_INFO                         = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_PARTY_INFO                       = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT1           = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT2           = 0x000,  // 5.0.5 16048
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x000,  // 5.0.5 16048
    SMSG_COMPLAIN_RESULT                              = 0x000,  // 5.0.5 16048
    ...
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x002B, // 5.4.0 17399 (JamList)
    SMSG_CREATURE_QUERY_RESPONSE                      = 0x1B4,  // 5.4.0 17371
    SMSG_CRITERIA_DELETED                             = 0x000,  // 5.0.5 16048
    SMSG_CRITERIA_UPDATE                              = 0x000,  // 5.0.5 16048
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x000,  // 5.0.5 16048
    SMSG_CURRENCY_LOOT_REMOVED                        = 0x000,  // 5.0.5 16048
    SMSG_CURRENCY_LOOT_RESTORED                       = 0x000,  // 5.0.5 16048 Deprecated 0x30A0 4.3.4
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x000,  // 5.0.5 16048
    ...
    SMSG_DISPLAY_PROMOTION                            = 0x809,  // 5.4.0 17371 - uint32(idPromotion)
    SMSG_DB_REPLY                                     = 0x025,  // 5.4.0 17371
    SMSG_DEATH_RELEASE_LOC                            = 0x000,  // 5.0.5 16048
    SMSG_DEBUG_RUNE_REGEN                             = 0x000,  // 5.0.5 16048
    SMSG_DEFENSE_MESSAGE                              = 0x000,  // 5.0.5 16048
    SMSG_DESTROY_OBJECT                               = 0x000,  // 5.0.5 16048
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x000,  // 5.0.5 16048
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x000,  // 5.0.5 16048
    SMSG_DISENCHANT_CREDIT                            = 0x000,  // 5.0.5 16048
    SMSG_DISMOUNT                                     = 0x003E, // 5.4.0 17399 (JamList)
    SMSG_DISMOUNTRESULT                               = 0x0001, // 5.4.0 17399 (JamList)
    ...
    SMSG_DUEL_INBOUNDS                                = 0x000,  // 5.0.5 16048
    SMSG_DUEL_OUTOFBOUNDS                             = 0x000,  // 5.0.5 16048
    SMSG_DUEL_REQUESTED                               = 0x000,  // 5.0.5 16048
    SMSG_DUEL_WINNER                                  = 0x000,  // 5.0.5 16048
    SMSG_DUMP_RIDE_TICKETS_RESPONSE                   = 0x000,  // 5.0.5 16048
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x000,  // 5.0.5 16048
    SMSG_ECHO_PARTY_SQUELCH                           = 0x000,  // 5.0.5 16048
    SMSG_EMOTE                                        = 0x000,  // 5.0.5 16048
    SMSG_ENABLE_BARBER_SHOP                           = 0x000,  // 5.0.5 16048
    SMSG_ENCHANTMENTLOG                               = 0x000,  // 5.0.5 16048
    SMSG_ENVIRONMENTALDAMAGELOG                       = 0x000,  // 5.0.5 16048
    SMSG_EQUIPMENT_SET_LIST                           = 0x000,  // 5.0.5 16048
    SMSG_EQUIPMENT_SET_SAVED                          = 0x000,  // 5.0.5 16048
    SMSG_EQUIPMENT_SET_USE_RESULT                     = 0x000,  // 5.0.5 16048
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x000,  // 5.0.5 16048
    SMSG_EXPLORATION_EXPERIENCE                       = 0x000,  // 5.0.5 16048
    SMSG_FAILED_PLAYER_CONDITION                      = 0x000,  // 5.0.5 16048
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x0B9,  // 5.4.0 17371
    SMSG_FEIGN_DEATH_RESISTED                         = 0x000,  // 5.0.5 16048
    SMSG_FISH_ESCAPED                                 = 0x000,  // 5.0.5 16048
    SMSG_FISH_NOT_HOOKED                              = 0x000,  // 5.0.5 16048
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x000,  // 5.0.5 16048
    SMSG_FLOOD_DETECTED                               = 0x000,  // 5.0.5 16048
    SMSG_FORCEACTIONSHOW                              = 0x000,  // 5.0.5 16048
    SMSG_FORCED_DEATH_UPDATE                          = 0x000,  // 5.0.5 16048
    SMSG_FORCE_DISPLAY_UPDATE                         = 0x000,  // 5.0.5 16048
    SMSG_FORCE_SEND_QUEUED_PACKETS                    = 0x000,  // 5.0.5 16048
    SMSG_FORCE_SET_VEHICLE_REC_ID                     = 0x000,  // 5.0.5 16048
    SMSG_FORGE_MASTER_SET                             = 0x000,  // 5.0.5 16048
    SMSG_FRIEND_STATUS                                = 0x000,  // 5.0.5 16048
    SMSG_GAMEOBJECT_CUSTOM_ANIM                       = 0x000,  // 5.0.5 16048
    ...
    SMSG_GAMEOBJECT_RESET_STATE                       = 0x000,  // 5.0.5 16048
    SMSG_GAMESPEED_SET                                = 0x0589, // 5.4.0 17399 (JamList)
    SMSG_GAMETIME_SET                                 = 0x000,  // 5.0.5 16048
    SMSG_GAMETIME_UPDATE                              = 0x000,  // 5.0.5 16048
    SMSG_GAME_EVENT_DEBUG_LOG                         = 0x000,  // 5.0.5 16048
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x000,  // 5.0.5 16048
    SMSG_GMRESPONSE_DB_ERROR                          = 0x000,  // 5.0.5 16048
    SMSG_GMRESPONSE_RECEIVED                          = 0x000,  // 5.0.5 16048
    SMSG_GMRESPONSE_STATUS_UPDATE                     = 0x000,  // 5.0.5 16048
    SMSG_GMTICKET_CREATE                              = 0x000,  // 5.0.5 16048
    SMSG_GMTICKET_DELETETICKET                        = 0x000,  // 5.0.5 16048
    SMSG_GMTICKET_GETTICKET                           = 0x000,  // 5.0.5 16048
    SMSG_GMTICKET_SYSTEMSTATUS                        = 0x000,  // 5.0.5 16048
    SMSG_GMTICKET_UPDATETEXT                          = 0x000,  // 5.0.5 16048
    SMSG_GM_MESSAGECHAT                               = 0x000,  // 5.0.5 16048
    SMSG_GM_PLAYER_INFO                               = 0x000,  // 5.0.5 16048
    SMSG_GM_TICKET_STATUS_UPDATE                      = 0x000,  // 5.0.5 16048
    SMSG_GM_RESURRECT_SUCESS                          = 0x0029, // 5.4.0 17399 (JamList) (NYI)
    SMSG_GODMODE                                      = 0x000,  // 5.0.5 16048
    SMSG_GOSSIP_COMPLETE                              = 0x000,  // 5.0.5 16048
    SMSG_GOSSIP_MESSAGE                               = 0x000,  // 5.0.5 16048
    SMSG_GOSSIP_POI                                   = 0x000,  // 5.0.5 16048
    SMSG_GROUPACTION_THROTTLED                        = 0x000,  // 5.0.5 16048
    SMSG_GROUP_CANCEL                                 = 0x000,  // 5.0.5 16048
    SMSG_GROUP_DECLINE                                = 0x000,  // 5.0.5 16048
    SMSG_GROUP_DESTROYED                              = 0x000,  // 5.0.5 16048
    SMSG_GROUP_INVITE                                 = 0x000,  // 5.0.5 16048
    ...
    SMSG_GUILD_BANK_LIST                              = 0x000,  // 5.0.5 16048
    SMSG_GUILD_BANK_LOG_QUERY_RESULT                  = 0x000,  // 5.0.5 16048
    SMSG_GUILD_BANK_MONEY_WITHDRAWN                   = 0x000,  // 5.0.5 16048
    SMSG_GUILD_BANK_QUERY_TEXT_RESULT                 = 0x000,  // 5.0.5 16048
    ...
    SMSG_GUILD_CRITERIA_DATA                          = 0x000,  // 5.0.5 16048
    SMSG_GUILD_CRITERIA_DELETED                       = 0x000,  // 5.0.5 16048
    SMSG_GUILD_DECLINE                                = 0x000,  // 5.0.5 16048
    SMSG_GUILD_EVENT                                  = 0x000,  // 5.0.5 16048
    SMSG_GUILD_EVENT_LOG_QUERY_RESULT                 = 0x000,  // 5.0.5 16048
    SMSG_GUILD_FLAGGED_FOR_RENAME                     = 0x000,  // 5.0.5 16048
    SMSG_GUILD_INVITE                                 = 0x000,  // 5.0.5 16048
    ...
    SMSG_INSPECT_RATED_BG_STATS                       = 0x000,  // 5.0.5 16048
    SMSG_INSPECT_HONOR_STATS                          = 0x000,  // 5.0.5 16048
    SMSG_INSPECT_RESULTS_UPDATE                       = 0x000,  // 5.0.5 16048
    SMSG_INSPECT_TALENT                               = 0x000,  // 5.0.5 16048
    SMSG_INSTANCE_DIFFICULTY                          = 0x000,  // 5.0.5 16048
    SMSG_INSTANCE_LOCK_WARNING_QUERY                  = 0x000,  // 5.0.5 16048
    SMSG_INSTANCE_RESET                               = 0x000,  // 5.0.5 16048
    SMSG_INSTANCE_RESET_FAILED                        = 0x000,  // 5.0.5 16048
    ...
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x083C, // 5.4.0 17399 (JamList)
    SMSG_ITEM_PUSH_RESULT                             = 0x0008, // 5.4.0 17399 (JamList)
    SMSG_ITEM_REFUND_INFO_RESPONSE                    = 0x000,  // 5.0.5 16048
    SMSG_ITEM_REFUND_RESULT                           = 0x000,  // 5.0.5 16048
    SMSG_ITEM_REMOVE_PASSIVE                          = 0x000,  // 5.0.5 16048
    SMSG_ITEM_SEND_PASSIVE                            = 0x000,  // 5.0.5 16048
    SMSG_ITEM_TEXT_QUERY_RESPONSE                     = 0x000,  // 5.0.5 16048
    SMSG_ITEM_TIME_UPDATE                             = 0x053D, // 5.4.0 17399 (JamList)
    SMSG_JOINED_BATTLEGROUND_QUEUE                    = 0x000,  // 5.0.5 16048
    SMSG_KICK_REASON                                  = 0x0920, // 5.4.0 17399 (JamList)
    ...
    SMSG_LFG_OFFER_CONTINUE                           = 0x000,  // 5.0.5 16048
    SMSG_LFG_OPEN_FROM_GOSSIP                         = 0x000,  // 5.0.5 16048
    SMSG_LFG_PARTY_INFO                               = 0x000,  // 5.0.5 16048
    SMSG_LFG_PLAYER_INFO                              = 0x000,  // 5.0.5 16048
    SMSG_LFG_PLAYER_REWARD                            = 0x000,  // 5.0.5 16048
    SMSG_LFG_PROPOSAL_UPDATE                          = 0x000,  // 5.0.5 16048
    SMSG_LFG_QUEUE_STATUS                             = 0x008D, // 5.4.0 17399 (JamList)
    SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x000,  // 5.0.5 16048
    SMSG_LFG_ROLE_CHOSEN                              = 0x000,  // 5.0.5 16048
    SMSG_LFG_SLOT_INVALID                             = 0x0080, // 5.4.0 17399 (JamList)
    SMSG_LFG_TELEPORT_DENIED                          = 0x000,  // 5.0.5 16048
    ...
    SMSG_LFG_UPDATE_STATUS                            = 0x000,  // 5.0.5 16048
    SMSG_LFG_UPDATE_STATUS_NONE                       = 0x000,  // 5.0.5 16048
    ...
    SMSG_LOGOUT_COMPLETE                              = 0x0A8,  // 5.4.0 17371
    SMSG_LOGOUT_RESPONSE                              = 0x8AD,  // 5.4.0 17371
    SMSG_LOG_XPGAIN                                   = 0x000,  // 5.0.5 16048
    SMSG_LOOT_ALL_PASSED                              = 0x000,  // 5.0.5 16048
    SMSG_LOOT_CLEAR_MONEY                             = 0x000,  // 5.0.5 16048
    SMSG_LOOT_CONTENTS                                = 0x000,  // 5.0.5 16048
    SMSG_LOOT_LIST                                    = 0x000,  // 5.0.5 16048
    SMSG_LOOT_MASTER_LIST                             = 0x000,  // 5.0.5 16048
    SMSG_LOOT_MONEY_NOTIFY                            = 0x000,  // 5.0.5 16048
    ...
    SMSG_LOOT_RELEASE                                 = 0x0033, // 5.4.0 17399 (JamList)
    SMSG_LOOT_RELEASE_ALL                             = 0x051C, // 5.4.0 17399 (JamList) (NYI?)
    SMSG_LOOT_REMOVED                                 = 0x000,  // 5.0.5 16048
    SMSG_LOOT_RESPONSE                                = 0x0082, // 5.4.0 17399 (JamList)
    SMSG_LOOT_ROLL                                    = 0x0526, // 5.4.0 17399 (JamList)
    SMSG_LOOT_ROLL_WON                                = 0x01BD, // 5.4.0 17399 (JamList)
    SMSG_LOOT_START_ROLL                              = 0x0510, // 5.4.0 17399 (JamList)
    SMSG_COIN_REMOVED                                 = 0x0003, // 5.4.0 17399 (JamList)
    SMSG_MAIL_LIST_RESULT                             = 0x000,  // 5.0.5 16048
    SMSG_MAP_OBJ_EVENTS                               = 0x000,  // 5.0.5 16048
    ...
    SMSG_MESSAGECHAT                                  = 0x92F,  // 5.4.0 17399
    SMSG_MESSAGE_BOX                                  = 0x000,  // 5.0.5 16048
    SMSG_MINIGAME_SETUP                               = 0x000,  // 5.0.5 16048
    SMSG_MINIGAME_STATE                               = 0x000,  // 5.0.5 16048
    SMSG_MIRRORIMAGE_DATA                             = 0x000,  // 5.0.5 16048
    ...
    SMSG_MOVE_UPDATE                                  = 0x139F, // 5.4.0 17371
    ...
    SMSG_MOVE_SET_FLIGHT_BACK_SPEED                   = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_FLIGHT_SPEED                        = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_HOVER                               = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_PITCH_RATE                          = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_RUN_BACK_SPEED                      = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_RUN_SPEED                           = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_SWIM_BACK_SPEED                     = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_SWIM_SPEED                          = 0x000,  // 5.0.5 16048
    SMSG_MOVE_SET_TURN_RATE                           = 0x000,  // 5.0.5 16048
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x0B7,  // 5.4.0 17371
    SMSG_NEW_TAXI_PATH                                = 0x000,  // 5.0.5 16048
    SMSG_NEW_WORLD                                    = 0x000,  // 5.0.5 16048
    SMSG_NEW_WORLD_ABORT                              = 0x896,  // 5.4.0 17371
    SMSG_NOTIFICATION                                 = 0x000,  // 5.0.5 16048
    SMSG_NOTIFY_DANCE                                 = 0x000,  // 5.0.5 16048
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x000,  // 5.0.5 16048
    SMSG_NPC_TEXT_UPDATE                              = 0x000,  // 5.0.5 16048
    SMSG_NPC_WONT_TALK                                = 0x000,  // 5.0.5 16048
    SMSG_OFFER_PETITION_ERROR                         = 0x000,  // 5.0.5 16048
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x000,  // 5.0.5 16048
    SMSG_OPEN_CONTAINER                               = 0x000,  // 5.0.5 16048
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x000,  // 5.0.5 16048
    SMSG_OVERRIDE_LIGHT                               = 0x000,  // 5.0.5 16048
    SMSG_PAGE_TEXT_QUERY_RESPONSE                     = 0x000,  // 5.0.5 16048
    SMSG_PARTYKILLLOG                                 = 0x000,  // 5.0.5 16048
    SMSG_PARTY_COMMAND_RESULT                         = 0x000,  // 5.0.5 16048
    SMSG_PARTY_INVITE                                 = 0x001C, // 5.4.0 17399 (JamList)
    SMSG_PARTY_MEMBER_STATS                           = 0x000,  // 5.0.5 16048
    SMSG_PARTY_MEMBER_STATS_FULL                      = 0x000,  // 5.0.5 16048
    SMSG_PARTY_UPDATE                                 = 0x000,  // 5.0.5 16048
    SMSG_PAUSE_MIRROR_TIMER                           = 0x000,  // 5.0.5 16048
    SMSG_PERIODICAURALOG                              = 0x000,  // 5.0.5 16048
    SMSG_PETGODMODE                                   = 0x000,  // 5.0.5 16048
    SMSG_PETITION_ALREADY_SIGNED                      = 0x000C, // 5.4.0 17399 (JamList)
    SMSG_PETITION_QUERY_RESPONSE                      = 0x000,  // 5.0.5 16048
    SMSG_PETITION_SHOWLIST                            = 0x000,  // 5.0.5 16048
    SMSG_PETITION_SHOW_SIGNATURES                     = 0x000,  // 5.0.5 16048
    SMSG_PETITION_SIGN_RESULTS                        = 0x000,  // 5.0.5 16048
    SMSG_PET_ACTION_FEEDBACK                          = 0x000,  // 5.0.5 16048
    SMSG_PET_ACTION_SOUND                             = 0x000,  // 5.0.5 16048
    SMSG_PET_ADDED                                    = 0x000,  // 5.0.5 16048
    SMSG_PET_BROKEN                                   = 0x000,  // 5.0.5 16048
    SMSG_PET_BATTLE_CHAT_RESTRICTION                  = 0x04B0, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x0190, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_FULL_UPDATE                       = 0x0596, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_FINAL_ROUND                       = 0x00AE, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_FINISHED                          = 0x0593, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_FIRST_ROUND                       = 0x010B, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_MAX_GAME_LENGHT_WARNING           = 0x042D, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x0026, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_ROUND_RESULT                      = 0x0019, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_BATTLE_SLOT_UPDATE                       = 0x00AF, // 5.4.0 17399 PET_BATTLE NYI
    SMSG_PET_CAST_FAILED                              = 0x000,  // 5.0.5 16048
    SMSG_PET_DISMISS_SOUND                            = 0x000,  // 5.0.5 16048
    SMSG_PET_GUIDS                                    = 0x000,  // 5.0.5 16048
    SMSG_PET_LEARNED_SPELL                            = 0x000,  // 5.0.5 16048
    SMSG_PET_MODE                                     = 0x0030, // 5.4.0 17399 (JamList)
    SMSG_PET_NAME_INVALID                             = 0x000,  // 5.0.5 16048
    SMSG_PET_NAME_QUERY_RESPONSE                      = 0x000,  // 5.0.5 16048
    SMSG_PET_REMOVED_SPELL                            = 0x000,  // 5.0.5 16048
    SMSG_PET_RENAMEABLE                               = 0x000,  // 5.0.5 16048
    SMSG_PET_SLOT_UPDATED                             = 0x000,  // 5.0.5 16048
    SMSG_PET_SPELLS                                   = 0x000,  // 5.0.5 16048
    SMSG_PET_TAME_FAILURE                             = 0x000,  // 5.0.5 16048
    SMSG_PET_UPDATE_COMBO_POINTS                      = 0x0036, // 5.4.0 17399 (JamList)
    SMSG_PLAYED_TIME                                  = 0x000,  // 5.0.5 16048
    SMSG_PLAYERBINDERROR                              = 0x000,  // 5.0.5 16048
    SMSG_PLAYERBOUND                                  = 0x000,  // 5.0.5 16048
    SMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x000,  // 5.0.5 16048
    SMSG_PLAYER_SKINNED                               = 0x000,  // 5.0.5 16048
    ...
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x0022, // 5.4.0 17399 (JamList)
    SMSG_PLAY_SPELL_VISUAL                            = 0x000,  // 5.0.5 16048
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x000,  // 5.0.5 16048
    SMSG_PLAY_TIME_WARNING                            = 0x000,  // 5.0.5 16048
    SMSG_PONG                                         = 0x043,  // 5.4.0 17371
    SMSG_POWER_UPDATE                                 = 0x4AD,  // 5.4.0 17371
    SMSG_PRE_RESURRECT                                = 0x000,  // 5.0.5 16048
    SMSG_PROCRESIST                                   = 0x000,  // 5.0.5 16048
    SMSG_PROPOSE_LEVEL_GRANT                          = 0x000,  // 5.0.5 16048
    SMSG_PUREMOUNT_CANCELLED_OBSOLETE                 = 0x000,  // 5.0.5 16048
    SMSG_PVP_CREDIT                                   = 0x000,  // 5.0.5 16048
    SMSG_PVP_LOG_DATA                                 = 0x000,  // 5.0.5 16048
    SMSG_PVP_OPTIONS_ENABLED                          = 0x000,  // 5.0.5 16048
    SMSG_QUERY_QUESTS_COMPLETED_RESPONSE              = 0x000,  // 5.0.5 16048 Deprecated
    SMSG_QUERY_TIME_RESPONSE                          = 0x008B, // 5.4.0 17399 (JamList)
    ...
    SMSG_QUESTGIVER_REQUEST_ITEMS                     = 0x000,  // 5.0.5 16048
    SMSG_QUESTGIVER_STATUS                            = 0x000,  // 5.0.5 16048
    SMSG_QUESTGIVER_STATUS_MULTIPLE                   = 0x000,  // 5.0.5 16048
    SMSG_QUESTLOG_FULL                                = 0x000,  // 5.0.5 16048
    SMSG_QUESTUPDATE_ADD_ITEM                         = 0x000,  // 5.0.5 16048
    SMSG_QUESTUPDATE_ADD_KILL                         = 0x000,  // 5.0.5 16048
    SMSG_QUESTUPDATE_ADD_PVP_KILL                     = 0x000,  // 5.0.5 16048
    ...
    SMSG_QUEST_CONFIRM_ACCEPT                         = 0x000,  // 5.0.5 16048
    SMSG_QUEST_FORCE_REMOVE                           = 0x000,  // 5.0.5 16048
    SMSG_QUEST_POI_QUERY_RESPONSE                     = 0x000,  // 5.0.5 16048
    SMSG_QUEST_QUERY_RESPONSE                         = 0x000,  // 5.0.5 16048
    SMSG_RAID_GROUP_ONLY                              = 0x000,  // 5.0.5 16048
    SMSG_RAID_INSTANCE_INFO                           = 0x000,  // 5.0.5 16048
    SMSG_RAID_INSTANCE_MESSAGE                        = 0x000,  // 5.0.5 16048
    SMSG_RAID_MARKERS_CHANGED                         = 0x000,  // 5.0.5 16048
    SMSG_RAID_READY_CHECK_COMPLETED                   = 0x0085, // 5.4.0 17399 (JamList)
    SMSG_RAID_READY_CHECK_RESPONSE                    = 0x000,  // 5.0.5 16048
    SMSG_RAID_READY_CHECK_STARTED                     = 0x000,  // 5.0.5 16048
    SMSG_RAID_READY_CHECK_THROTTLED_ERROR             = 0x000,  // 5.0.5 16048
    SMSG_RAID_SUMMON_FAILED                           = 0x000,  // 5.0.5 16048
    SMSG_RAID_TARGET_UPDATE_SINGLE                    = 0x000,  // 5.0.5 16048
    SMSG_RAID_TARGET_UPDATE_ALL                       = 0x000,  // 5.0.5 16048
    SMSG_RANDOMIZE_CHAR_NAME                          = 0x000,  // 5.0.5 16048
    ...
    SMSG_REALM_QUERY_RESPONSE                         = 0x42B,  // 5.4.0 17371
    SMSG_REALM_SPLIT                                  = 0x099,  // 5.4.0 17371
    ...
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x000,  // 5.0.5 16048
    SMSG_REFER_A_FRIEND_FAILURE                       = 0x000,  // 5.0.5 16048
    SMSG_REFORGE_RESULT                               = 0x000,  // 5.0.5 16048
    SMSG_REFRESH_COMPONENT                            = 0x0028, // 5.4.0 17399 (JamList)
    ...
    SMSG_RESET_FAILED_NOTIFY                          = 0x000,  // 5.0.5 16048
    SMSG_RESISTLOG                                    = 0x000,  // 5.0.5 16048
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x000,  // 5.0.5 16048
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                 = 0x0084, // 5.4.0 17399 (JamList)
    SMSG_RESURRECT_REQUEST                            = 0x000,  // 5.0.5 16048
    SMSG_RESYNC_RUNES                                 = 0x000,  // 5.0.5 16048
    SMSG_ROLE_POLL_BEGIN                              = 0x000,  // 5.0.5 16048
    SMSG_RWHOIS                                       = 0x000,  // 5.0.5 16048
    SMSG_SCENE_OBJECT_PET_BATTLE_FINISHED             = 0x011E, // 5.4.0 17399 Scene systeme NYI
    SMSG_SCENE_OBJECT_PET_BATTLE_FIRST_ROUND          = 0x059A, // 5.4.0 17399 Scene systeme NYI
    SMSG_SCENE_OBJECT_PET_BATTLE_FULL_UPDATE          = 0x049B, // 5.4.0 17399 Scene systeme NYI
    SMSG_SCENE_OBJECT_PET_BATTLE_ROUND_RESULT         = 0x051B, // 5.4.0 17399 Scene systeme NYI
    SMSG_SELL_ITEM                                    = 0x000,  // 5.0.5 16048
    SMSG_SEND_MAIL_RESULT                             = 0x000,  // 5.0.5 16048
    SMSG_SEND_UNLEARN_SPELLS                          = 0x000,  // 5.0.5 16048
    SMSG_SERVERTIME                                   = 0x092E, // 5.4.0 17399 (JamList)
    SMSG_SERVER_FIRST_ACHIEVEMENT                     = 0x000,  // 5.0.5 16048
    SMSG_SERVER_INFO_QUERY_RESPONSE                   = 0x001F, // 5.4.0 17399 (JamList) (NYI)
    SMSG_SERVER_INFO_RESPONSE                         = 0x001A, // 5.4.0 17399 (JamList)
    SMSG_SERVER_MESSAGE                               = 0x000,  // 5.0.5 16048
    SMSG_SERVER_PERF                                  = 0x000,  // 5.0.5 16048
    SMSG_SETUP_RESEARCH_HISTORY                       = 0x000,  // 5.0.5 16048
    SMSG_SET_AI_ANIM_KIT                              = 0x000,  // 5.0.5 16048
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x000,  // 5.0.5 16048
    SMSG_SET_FACTION_ATWAR                            = 0x000,  // 5.0.5 16048
    SMSG_SET_FACTION_STANDING                         = 0x000,  // 5.0.5 16048
    SMSG_SET_FACTION_VISIBLE                          = 0x000,  // 5.0.5 16048
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x000,  // 5.0.5 16048
    SMSG_SET_FORCED_REACTIONS                         = 0x000,  // 5.0.5 16048
    SMSG_SET_MELEE_ANIM_KIT                           = 0x000,  // 5.0.5 16048
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x003C, // 5.4.0 17399 (JamList)
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x000,  // 5.0.5 16048
    SMSG_SET_PET_SPECIALIZATION                       = 0x000,  // 5.0.5 16048
    SMSG_SET_PHASE_SHIFT                              = 0x000,  // 5.0.5 16048
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x000,  // 5.0.5 16048
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x000,  // 5.0.5 16048
    SMSG_SET_PROFICIENCY                              = 0x000,  // 5.0.5 16048
    SMSG_SET_PROJECTILE_POSITION                      = 0x000,  // 5.0.5 16048
    SMSG_SHOWTAXINODES                                = 0x000,  // 5.0.5 16048
    SMSG_SHOW_BANK                                    = 0x0005, // 5.4.0 17399 (JamList)
    SMSG_SHOW_NEURTRAL_PLAYER_FACTION_SELECT_UI       = 0x000,  // 5.0.5 16048
    SMSG_SHOW_RATINGS                                 = 0x000,  // 5.0.5 16048
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x000,  // 5.0.5 16048
    ...
    SMSG_SPELL_FAILED_OTHER                           = 0x000,  // 5.0.5 16048
    SMSG_SPELL_FAILURE                                = 0x000,  // 5.0.5 16048
    SMSG_SPELL_GO                                     = 0x10B6, // 5.4.0 17399
    SMSG_SPELL_START                                  = 0x1C17, // 5.4.0 17399
    SMSG_SPELL_UPDATE_CHAIN_TARGETS                   = 0x000,  // 5.0.5 16048
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_COLLISION_DISABLE                = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_COLLISION_ENABLE                 = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_GRAVITY_DISABLE                  = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE                   = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_ROOT                             = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_FEATHER_FALL                 = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED            = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED                 = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_FLYING                       = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_HOVER                        = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_LAND_WALK                    = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_NORMAL_FALL                  = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_PITCH_RATE                   = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED               = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_RUN_MODE                     = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_RUN_SPEED                    = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED              = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_SWIM_SPEED                   = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_TURN_RATE                    = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_WALK_MODE                    = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_SET_WALK_SPEED                   = 0x000,  // 5.0.5 16048
    ...
    SMSG_SPLINE_MOVE_UNROOT                           = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_UNSET_FLYING                     = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_UNSET_HOVER                      = 0x000,  // 5.0.5 16048
    SMSG_SPLINE_MOVE_WATER_WALK                       = 0x000,  // 5.0.5 16048
    SMSG_STABLE_RESULT                                = 0x000,  // 5.0.5 16048
    SMSG_STANDSTATE_UPDATE                            = 0x000D, // 5.4.0 17399 (JamList)
    SMSG_START_ELAPSED_TIMER                          = 0x0038, // 5.4.0 17399 (JamList)
    SMSG_START_MIRROR_TIMER                           = 0x000,  // 5.0.5 16048
    SMSG_START_TIMER                                  = 0x000,  // 5.0.5 16048
    SMSG_STOP_DANCE                                   = 0x000,  // 5.0.5 16048
    SMSG_STOP_MIRROR_TIMER                            = 0x000,  // 5.0.5 16048
    ...
    SMSG_THREAT_REMOVE                                = 0x000,  // 5.0.5 16048
    SMSG_THREAT_UPDATE                                = 0x0012, // 5.4.0 17399 (JamList)
    SMSG_TIME_ADJUSTMENT                              = 0x000,  // 5.0.5 16048
    SMSG_TIME_SYNC_REQ                                = 0x000,  // 5.0.5 16048
    SMSG_TIME_ZONE_INFORMATION                        = 0x883,  // 5.4.0 17371 - Read7Bits x2 + ReadWoWString x2 : Sniffed "Europe/Paris" x 2
    SMSG_TITLE_EARNED                                 = 0x000,  // 5.0.5 16048
    SMSG_TOGGLE_XP_GAIN                               = 0x000,  // 5.0.5 16048
    SMSG_TOTEM_CREATED                                = 0x000,  // 5.0.5 16048
    SMSG_TRADE_STATUS                                 = 0x000,  // 5.0.5 16048
    SMSG_TRADE_STATUS_EXTENDED                        = 0x000,  // 5.0.5 16048
    SMSG_TRAINER_BUY_FAILED                           = 0x0031, // 5.4.0 17399 (JamList) (NYI)
    SMSG_TRAINER_LIST                                 = 0x000,  // 5.0.5 16048
    SMSG_TRAINER_SERVICE                              = 0x000,  // 5.0.5 16048
    SMSG_TRANSFER_ABORTED                             = 0x000,  // 5.0.5 16048
    SMSG_TRANSFER_PENDING                             = 0x000,  // 5.0.5 16048
    SMSG_TRIGGER_CINEMATIC                            = 0x000,  // 5.0.5 16048
    SMSG_TRIGGER_MOVIE                                = 0x000,  // 5.0.5 16048
    SMSG_TURN_IN_PETITION_RESULTS                     = 0x000,  // 5.0.5 16048
    SMSG_TUTORIAL_FLAGS                               = 0x1F35, // 5.4.0 17371
    SMSG_UNIT_HEALTH_FREQUENT                         = 0x000,  // 5.0.5 16048
    SMSG_UNIT_SPELLCAST_START                         = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x0A9,	// 5.4.0 17371
    SMSG_UPDATE_ACCOUNT_DATA_COMPLETE                 = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_COMBO_POINTS                          = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_CURRENCY                              = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_CURRENCY_WEEK_LIMIT                   = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x0081, // 5.4.0 17399 (JamList) (NYI)
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT               = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x0089, // 5.4.0 17399 (JamList)
    SMSG_UPDATE_ITEM_ENCHANTMENTS                     = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_LAST_INSTANCE                         = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_OBJECT                                = 0x17D9, // 5.4.0 17371
    SMSG_UPDATE_SERVER_PLAYER_POSITION                = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_TALENT_DATA                           = 0x000,  // 5.0.5 16048
    SMSG_UPDATE_WORLD_STATE                           = 0x000,  // 5.0.5 16048
    SMSG_USERLIST_ADD                                 = 0x000,  // 5.0.5 16048
    SMSG_USERLIST_REMOVE                              = 0x000,  // 5.0.5 16048
    SMSG_USERLIST_UPDATE                              = 0x000,  // 5.0.5 16048
    SMSG_VOICESESSION_FULL                            = 0x000,  // 5.0.5 16048
    SMSG_VOICE_CHAT_STATUS                            = 0x000,  // 5.0.5 16048
    SMSG_VOICE_PARENTAL_CONTROLS                      = 0x000,  // 5.0.5 16048
    SMSG_VOICE_SESSION_LEAVE                          = 0x000,  // 5.0.5 16048
    SMSG_VOICE_SESSION_ROSTER_UPDATE                  = 0x000,  // 5.0.5 16048
    SMSG_VOICE_SET_TALKER_MUTED                       = 0x000,  // 5.0.5 16048
    SMSG_VOID_ITEM_SWAP_RESPONSE                      = 0x000,  // 5.0.5 16048
    SMSG_VOID_STORAGE_CONTENTS                        = 0x000,  // 5.0.5 16048
    SMSG_VOID_STORAGE_FAILED                          = 0x000,  // 5.0.5 16048
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x000,  // 5.0.5 16048
    SMSG_VOID_TRANSFER_RESULT                         = 0x000,  // 5.0.5 16048
    SMSG_WAIT_QUEUE_FINISH                            = 0x000,  // 5.0.5 16048
    SMSG_WAIT_QUEUE_UPDATE                            = 0x000,  // 5.0.5 16048
    SMSG_WARDEN_DATA                                  = 0x002,  // 5.4.0 17371
    SMSG_WARGAME_CHECK_ENTRY                          = 0x000,  // 5.0.5 16048
    SMSG_WARGAME_REQUEST_SENT                         = 0x000,  // 5.0.5 16048
    SMSG_WEATHER                                      = 0x000,  // 5.0.5 16048
    SMSG_WEEKLY_LAST_RESET                            = 0x000,  // 5.0.5 16048
    ...
    SMSG_WHO                                          = 0x000,  // 5.0.5 16048
    SMSG_WHOIS                                        = 0x000,  // 5.0.5 16048
    SMSG_WORLD_SERVER_INFO                            = 0x000,  // 5.0.5 16048
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                  = 0x000,  // 5.0.5 16048
    SMSG_XP_GAIN_ABORTED                              = 0x000,  // 5.0.5 16048
