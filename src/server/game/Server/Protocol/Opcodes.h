...
enum Opcodes
{
    ...
    #pragma region JamDispatch
        /// Base opcodes
        SMSG_AUTH_RESPONSE                          = 0x0403, ///< 6.2.0 20173
        SMSG_CACHE_VERSION                          = 0x0932, ///< 6.2.0 20173
        SMSG_ADDON_INFO                             = 0x0B21, ///< 6.2.0 20173
        SMSG_FEATURE_SYSTEM_STATUS                  = 0x0090, ///< 6.2.0 20173
        SMSG_SET_TIME_ZONE_INFORMATION              = 0x0E9C, ///< 6.2.0 20173
        SMSG_LOGIN_VERIFY_WORLD                     = 0x0CD3, ///< 6.2.0 20173
        SMSG_NEW_WORLD                              = 0x0026, ///< 6.2.0 20173
        SMSG_LOGIN_SET_TIME_SPEED                   = 0x0C47, ///< 6.2.0 20173
        SMSG_HOTFIX_NOTIFY_BLOB                     = 0x0095, ///< 6.2.0 20173
        SMSG_HOTFIX_NOTIFY                          = 0x0AA1, ///< 6.2.0 20173
        SMSG_WORLD_SERVER_INFO                      = 0x0626, ///< 6.2.0 20173
        SMSG_INITIAL_SETUP                          = 0x02CC, ///< 6.2.0 20173
        SMSG_PONG                                   = 0x0000, ///< Autoparser error - Opcode not found. Old Opcode: 0x005E
        SMSG_UITIME                                 = 0x0B52, ///< 6.2.0 20173

        /// Query
        SMSG_DB_REPLY                               = 0x0C5F, ///< 6.2.0 20173
        SMSG_QUERY_CREATURE_RESPONSE                = 0x0EDB, ///< 6.2.0 20173
        SMSG_NPC_TEXT_UPDATE                        = 0x049B, ///< 6.2.0 20173
        SMSG_NAME_QUERY_RESPONSE                    = 0x0331, ///< 6.2.0 20173
        SMSG_REALM_QUERY_RESPONSE                   = 0x0E0F, ///< 6.2.0 20173
        SMSG_GAMEOBJECT_QUERY_RESPONSE              = 0x04CC, ///< 6.2.0 20173
        SMSG_QUERY_TIME_RESPONSE                    = 0x05A6, ///< 6.2.0 20173

        /// Misc
        SMSG_UPDATE_ACTION_BUTTONS                  = 0x0A0B, ///< 6.2.0 20173
        SMSG_SET_PROFICIENCY                        = 0x0A53, ///< 6.2.0 20173
        SMSG_INIT_WORLD_STATES                      = 0x0E53, ///< 6.2.0 20173
        SMSG_UPDATE_WORLD_STATE                     = 0x0036, ///< 6.2.0 20173
        SMSG_EMOTE                                  = 0x0531, ///< 6.2.0 20173
        SMSG_EXPLORATION_EXPERIENCE                 = 0x0C90, ///< 6.2.0 20173
        SMSG_LOG_XP_GAIN                            = 0x0C84, ///< 6.2.0 20173
        SMSG_LEVELUP_INFO                           = 0x01D2, ///< 6.2.0 20173
        SMSG_ITEM_PUSH_RESULT                       = 0x0690, ///< 6.2.0 20173
        SMSG_INIT_CURRENCY                          = 0x0901, ///< 6.2.0 20173
        SMSG_UPDATE_CURRENCY                        = 0x0E07, ///< 6.2.0 20173
        SMSG_UPDATE_CURRENCY_WEEK_LIMIT             = 0x0447, ///< 6.2.0 20173
        SMSG_WEEKLY_RESET_CURRENCY                  = 0x0ECC, ///< 6.2.0 20173
        SMSG_EQUIPMENT_SET_LIST                     = 0x06DF, ///< 6.2.0 20173
        SMSG_BINDER_CONFIRM                         = 0x0497, ///< 6.2.0 20173
        SMSG_BIND_POINT_UPDATE                      = 0x00C4, ///< 6.2.0 20173
        SMSG_UPDATE_TALENT_DATA                     = 0x0057, ///< 6.2.0 20173
        SMSG_TRANSFER_ABORTED                       = 0x03C2, ///< 6.2.0 20173
        SMSG_TRANSFER_PENDING                       = 0x05B5, ///< 6.2.0 20173
        SMSG_INVENTORY_CHANGE_FAILURE               = 0x0C4B, ///< 6.2.0 20173
        SMSG_SET_DUNGEON_DIFFICULTY                 = 0x0A94, ///< 6.2.0 20173
        SMSG_SET_RAID_DIFFICULTY                    = 0x0296, ///< 6.2.0 20173
        SMSG_LOAD_CUF_PROFILES                      = 0x0848, ///< 6.2.0 20173
        SMSG_STANDSTATE_UPDATE                      = 0x0A52, ///< 6.2.0 20173
        SMSG_START_TIMER                            = 0x0F26, ///< 6.2.0 20173
        SMSG_START_ELAPSED_TIMER                    = 0x0498, ///< 6.2.0 20173
        SMSG_START_ELAPSED_TIMERS                   = 0x048F, ///< 6.2.0 20173
        SMSG_STOP_ELAPSED_TIMER                     = 0x0A8C, ///< 6.2.0 20173
        SMSG_DEATH_RELEASE_LOC                      = 0x0A5C, ///< 6.2.0 20173
        SMSG_CORPSE_RECLAIM_DELAY                   = 0x0031, ///< 6.2.0 20173
        SMSG_CORPSE_LOCATION                        = 0x0905, ///< 6.2.0 20173
        SMSG_CORPSE_TRANSPORT_QUERY                 = 0x02A0, ///< 6.2.0 20173
        SMSG_DURABILITY_DAMAGE_DEATH                = 0x0698, ///< 6.2.0 20173
        SMSG_PLAY_MUSIC                             = 0x0942, ///< 6.2.0 20173
        SMSG_PLAY_OBJECT_SOUND                      = 0x061B, ///< 6.2.0 20173
        SMSG_PLAY_SOUND                             = 0x0044, ///< 6.2.0 20173
        SMSG_DISPLAY_TOAST                          = 0x0B25, ///< 6.2.0 20173
        SMSG_ITEM_ENCHANT_TIME_UPDATE               = 0x0236, ///< 6.2.0 20173
        SMSG_ENCHANTMENT_LOG                        = 0x0926, ///< 6.2.0 20173
        SMSG_PARTY_KILL_LOG                         = 0x00A0, ///< 6.2.0 20173
        SMSG_PROCRESIST                             = 0x0951, ///< 6.2.0 20173
        SMSG_CLEAR_TARGET                           = 0x02D5, ///< 6.2.0 20173
        SMSG_WEATHER                                = 0x0131, ///< 6.2.0 20173
        SMSG_SET_PHASE_SHIFT                        = 0x0C36, ///< 6.2.0 20173
        SMSG_TRIGGER_CINEMATIC                      = 0x0422, ///< 6.2.0 20173
        SMSG_TOTEM_CREATED                          = 0x0851, ///< 6.2.0 20173
        SMSG_RESPEC_WIPE_CONFIRM                    = 0x0E21, ///< 6.2.0 20173
        SMSG_USE_EQUIPMENT_SET_RESULT               = 0x0EA5, ///< 6.2.0 20173
        SMSG_TRADE_STATUS                           = 0x0A9C, ///< 6.2.0 20173
        SMSG_TRADE_UPDATED                          = 0x0EA0, ///< 6.2.0 20173
        SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI  = 0x068C, ///< 6.2.0 20173
        SMSG_NEUTRAL_PLAYER_FACTION_SELECT_RESULT   = 0x0000, ///< (unused)
        SMSG_INSPECT_TALENT                         = 0x01B2, ///< 6.2.0 20173
        SMSG_INSPECT_HONOR_STATS                    = 0x0AC7, ///< 6.2.0 20173
        SMSG_INSPECT_RATED_BG_STATS                 = 0x08D3, ///< 6.2.0 20173
        SMSG_TIME_SYNC_REQUEST                      = 0x1097, ///< 6.2.0 20173
        SMSG_RESUME_TOKEN                           = 0x0E08, ///< 6.2.0 20173
        SMSG_BARBER_SHOP_RESULT                     = 0x0E44, ///< 6.2.0 20173
        SMSG_ENABLE_BARBER_SHOP                     = 0x09C6, ///< 6.2.0 20173
        SMSG_PAGE_TEXT_QUERY_RESPONSE               = 0x0022, ///< 6.2.0 20173
        SMSG_PAGE_TEXT                              = 0x0A4B, ///< 6.2.0 20173
        SMSG_READ_ITEM_FAILED                       = 0x0283, ///< 6.2.0 20173
        SMSG_READ_ITEM_OK                           = 0x0826, ///< 6.2.0 20173
        SMSG_TEXT_EMOTE                             = 0x0C54, ///< 6.2.0 20173
        SMSG_TITLE_EARNED                           = 0x0A0C, ///< 6.2.0 20173
        SMSG_TITLE_LOST                             = 0x0852, ///< 6.2.0 20173
        SMSG_WHOIS                                  = 0x0841, ///< 6.2.0 20173
        SMSG_TRIGGER_MOVIE                          = 0x045C, ///< 6.2.0 20173
        SMSG_UPDATE_LAST_INSTANCE                   = 0x0C0F, ///< 6.2.0 20173
        SMSG_UPDATE_INSTANCE_OWNERSHIP              = 0x03D1, ///< 6.2.0 20173
        SMSG_SUMMON_REQUEST                         = 0x0053, ///< 6.2.0 20173
        SMSG_STOP_MIRROR_TIMER                      = 0x0293, ///< 6.2.0 20173
        SMSG_START_MIRROR_TIMER                     = 0x0E32, ///< 6.2.0 20173
        SMSG_SOCKET_GEMS                            = 0x061C, ///< 6.2.0 20173
        SMSG_RESURRECT_REQUEST                      = 0x08A6, ///< 6.2.0 20173
        SMSG_RESPOND_INSPECT_ACHIEVEMENTS           = 0x0B32, ///< 6.2.0 20173
        SMSG_RESET_FAILED_NOTIFY                    = 0x088F, ///< 6.2.0 20173
        SMSG_SETUP_RESEARCH_HISTORY                 = 0x0325, ///< 6.2.0 20173
        SMSG_RESEARCH_COMPLETE                      = 0x0297, ///< 6.2.0 20173
        SMSG_REQUEST_CEMETERY_LIST_RESPONSE         = 0x00A1, ///< 6.2.0 20173
        SMSG_PLAYED_TIME                            = 0x0842, ///< 6.2.0 20173
        SMSG_BREAK_TARGET                           = 0x0A44, ///< 6.2.0 20173
        SMSG_CANCEL_AUTO_REPEAT                     = 0x0814, ///< 6.2.0 20173
        SMSG_CANCEL_COMBAT                          = 0x020F, ///< 6.2.0 20173
        SMSG_COMPLAIN_RESULT                        = 0x0D31, ///< 6.2.0 20173
        SMSG_XPGAIN_ABORTED                         = 0x01A6, ///< 6.2.0 20173
        SMSG_SUPERCEDED_SPELL                       = 0x023A, ///< 6.2.0 20173
        SMSG_PVP_CREDIT                             = 0x0726, ///< 6.2.0 20173
        SMSG_PRE_RESURRECT                          = 0x01A5, ///< 6.2.0 20173
        SMSG_PLAY_ONE_SHOT_ANIM_KIT                 = 0x0017, ///< 6.2.0 20173
        SMSG_SET_AI_ANIM_KIT                        = 0x0E36, ///< 6.2.0 20173
        SMSG_PLAYER_BOUND                           = 0x08A0, ///< 6.2.0 20173
        SMSG_OVERRIDE_LIGHT                         = 0x08DC, ///< 6.2.0 20173
        SMSG_PRINT_NOTIFICATION                     = 0x0E20, ///< 6.2.0 20173
        SMSG_SPECIAL_MOUNT_ANIM                     = 0x0E13, ///< 6.2.0 20173
        SMSG_ITEM_TIME_UPDATE                       = 0x0EB2, ///< 6.2.0 20173
        SMSG_QUERY_ITEM_TEXT_RESPONSE               = 0x0CDB, ///< 6.2.0 20173
        SMSG_ITEM_PURCHASE_REFUND_RESULT            = 0x0047, ///< 6.2.0 20173
        SMSG_GAMEOBJECT_DESPAWN                     = 0x0E88, ///< 6.2.0 20173
        SMSG_GAMEOBJECT_CUSTOM_ANIM                 = 0x0FB2, ///< 6.2.0 20173
        SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT          = 0x0335, ///< 6.2.0 20173
        SMSG_FISH_NOT_HOOKED                        = 0x0955, ///< 6.2.0 20173
        SMSG_FISH_ESCAPED                           = 0x0087, ///< 6.2.0 20173
        SMSG_DESTRUCTIBLE_BUILDING_DAMAGE           = 0x02C8, ///< 6.2.0 20173
        SMSG_CROSSED_INEBRIATION_THRESHOLD          = 0x08D6, ///< 6.2.0 20173
        SMSG_CLIENT_CONTROL_UPDATE                  = 0x004B, ///< 6.2.0 20173
        SMSG_AREA_TRIGGER_NO_CORPSE                 = 0x0E90, ///< 6.2.0 20173
        SMSG_BAG_SORT_RESULT                        = 0x065C, ///< 6.2.0 20173
        SMSG_VIGNETTE_UPDATE                        = 0x08CC, ///< 6.2.0 20173
        SMSG_ACCOUNT_MOUNT_UPDATE                   = 0x085C, ///< 6.2.0 20173
        SMSG_PLAY_SCENE                             = 0x0BD6, ///< 6.2.0 20173
        SMSG_CANCEL_SCENE                           = 0x0A15, ///< 6.2.0 20173
        SMSG_TALENTS_INVOLUNTARILY_RESET            = 0x0000, ///< Autoparser error - Opcode not found. Old Opcode: 0x01E3
        SMSG_SET_ITEM_PURCHASE_DATA                 = 0x1085, ///< 6.2.0 20173
        SMSG_SHOW_TRADE_SKILL_RESPONSE              = 0x0C97, ///< 6.2.0 20173

        /// Control Alert
        SMSG_LOSS_OF_CONTROL_AURA_UPDATE            = 0x0217, ///< 6.2.0 20173
        SMSG_ADD_LOSS_OF_CONTROL                    = 0x0CB6, ///< 6.2.0 20173
        SMSG_CLEAR_LOSS_OF_CONTROL                  = 0x0883, ///< 6.2.0 20173
        SMSG_REMOVE_LOSS_OF_CONTROL                 = 0x0097, ///< 6.2.0 20173

        /// Reputations
        SMSG_INITIALIZE_FACTIONS                    = 0x048B, ///< 6.2.0 20173
        SMSG_FACTION_BONUS_INFO                     = 0x0897, ///< 6.2.0 20173
        SMSG_SET_FACTION_VISIBLE                    = 0x0843, ///< 6.2.0 20173
        SMSG_SET_FACTION_NOT_VISIBLE                = 0x04E0, ///< 6.2.0 20173
        SMSG_SET_FACTION_STANDING                   = 0x041C, ///< 6.2.0 20173
        SMSG_SET_FACTION_ATWAR                      = 0x04DC, ///< 6.2.0 20173
        SMSG_SET_FORCED_REACTIONS                   = 0x0C4C, ///< 6.2.0 20173

        /// Interaction
        SMSG_LOGOUT_RESPONSE                        = 0x0535, ///< 6.2.0 20173
        SMSG_LOGOUT_CANCEL_ACK                      = 0x0817, ///< 6.2.0 20173
        SMSG_LOGOUT_COMPLETE                        = 0x0618, ///< 6.2.0 20173
        SMSG_GOSSIP_POI                             = 0x0925, ///< 6.2.0 20173
        SMSG_ARCHAEOLOGY_SURVERY_CAST               = 0x0825, ///< 6.2.0 20173

        /// World Object management
        SMSG_UPDATE_OBJECT                          = 0x0D36, ///< 6.2.0 20173
        SMSG_POWER_UPDATE                           = 0x004F, ///< 6.2.0 20173

        /// Character list
        SMSG_ENUM_CHARACTERS_RESULT                 = 0x0290, ///< 6.2.0 20173
        SMSG_CREATE_CHAR                            = 0x0A16, ///< 6.2.0 20173
        SMSG_CHAR_DELETE                            = 0x0E9B, ///< 6.2.0 20173
        SMSG_SET_PLAYER_DECLINED_NAMES_RESULT       = 0x0CA2, ///< 6.2.0 20173
        SMSG_CHAR_FACTION_CHANGE                    = 0x0C22, ///< 6.2.0 20173
        SMSG_CHAR_RENAME                            = 0x00A6, ///< 6.2.0 20173
        SMSG_CHAR_CUSTOMIZE_RESULT                  = 0x041F, ///< 6.2.0 20173
        SMSG_CHAR_CUSTOMIZE                         = 0x0A1B, ///< 6.2.0 20173

        /// Account data
        SMSG_ACCOUNT_DATA_TIMES                     = 0x000C, ///< 6.2.0 20173
        SMSG_UPDATE_ACCOUNT_DATA                    = 0x02C3, ///< 6.2.0 20173
        SMSG_TUTORIAL_FLAGS                         = 0x0C5C, ///< 6.2.0 20173

        /// Combat
        SMSG_ATTACKER_STATE_UPDATE                  = 0x0813, ///< 6.2.0 20173
        SMSG_ATTACK_START                           = 0x01B5, ///< 6.2.0 20173
        SMSG_ATTACK_STOP                            = 0x0C57, ///< 6.2.0 20173
        SMSG_AI_REACTION                            = 0x080B, ///< 6.2.0 20173
        SMSG_ATTACK_SWING_ERROR                     = 0x0A95, ///< 6.2.0 20173

        /// Duel
        SMSG_DUEL_REQUESTED                         = 0x0941, ///< 6.2.0 20173
        SMSG_DUEL_COUNTDOWN                         = 0x0450, ///< 6.2.0 20173
        SMSG_DUEL_COMPLETE                          = 0x03D2, ///< 6.2.0 20173
        SMSG_DUEL_INBOUNDS                          = 0x069F, ///< 6.2.0 20173
        SMSG_DUEL_OUT_OF_BOUNDS                     = 0x08B6, ///< 6.2.0 20173
        SMSG_DUEL_WINNER                            = 0x0B15, ///< 6.2.0 20173
        SMSG_CAN_DUEL_RESULT                        = 0x0098, ///< 6.2.0 20173

        /// Vendor
        SMSG_LIST_INVENTORY                         = 0x0AD4, ///< 6.2.0 20173
        SMSG_BUY_FAILED                             = 0x0604, ///< 6.2.0 20173
        SMSG_BUY_ITEM                               = 0x0E26, ///< 6.2.0 20173
        SMSG_SELL_ITEM                              = 0x08DB, ///< 6.2.0 20173

        /// Achievement
        SMSG_ALL_ACHIEVEMENT_DATA                   = 0x0457, ///< 6.2.0 20173
        SMSG_ACHIEVEMENT_DELETED                    = 0x0093, ///< 6.2.0 20173
        SMSG_ACHIEVEMENT_EARNED                     = 0x01A1, ///< 6.2.0 20173
        SMSG_ACCOUNT_CRITERIA_UPDATE                = 0x09C5, ///< 6.2.0 20173
        SMSG_ACCOUNT_CRITERIA_UPDATE_ALL            = 0x0887, ///< 6.2.0 20173
        SMSG_CRITERIA_DELETED                       = 0x0EE0, ///< 6.2.0 20173
        SMSG_CRITERIA_UPDATE                        = 0x0BA5, ///< 6.2.0 20173

        /// Friends
        SMSG_CONTACT_LIST                           = 0x0B05, ///< 6.2.0 20173
        SMSG_FRIEND_STATUS                          = 0x0084, ///< 6.2.0 20173

        /// Taxi
        SMSG_TAXI_NODE_STATUS                       = 0x00DF, ///< 6.2.0 20173
        SMSG_NEW_TAXI_PATH                          = 0x0000, ///< Autoparser error - Opcode not found. Old Opcode: 0x080F
        SMSG_SHOW_TAXI_NODES                        = 0x1086, ///< 6.2.0 20173
        SMSG_ACTIVATE_TAXI_REPLY                    = 0x0A90, ///< 6.2.0 20173

        /// Loot
        SMSG_LOOT_LIST                              = 0x0AB6, ///< 6.2.0 20173
        SMSG_LOOT_RESPONSE                          = 0x0DB1, ///< 6.2.0 20173
        SMSG_LOOT_MONEY_NOTIFY                      = 0x0E94, ///< 6.2.0 20173
        SMSG_LOOT_RELEASE                           = 0x0404, ///< 6.2.0 20173
        SMSG_LOOT_RELEASE_ALL                       = 0x06A5, ///< 6.2.0 20173
        SMSG_LOOT_REMOVED                           = 0x0FA6, ///< 6.2.0 20173
        SMSG_COIN_REMOVED                           = 0x0846, ///< 6.2.0 20173
        SMSG_LOOT_ALL_PASSED                        = 0x089B, ///< 6.2.0 20173
        SMSG_LOOT_CONTENTS                          = 0x0000, ///< (unused)
        SMSG_LOOT_ITEM_LIST                         = 0x0000, ///< (unused)
        SMSG_MASTER_LOOT_CANDIDATE_LIST             = 0x0EC8, ///< 6.2.0 20173
        SMSG_LOOT_ROLL                              = 0x008F, ///< 6.2.0 20173
        SMSG_LOOT_ROLLS_COMPLETE                    = 0x0000, ///< (unused)
        SMSG_LOOT_ROLL_WON                          = 0x0DB2, ///< 6.2.0 20173
        SMSG_LOOT_START_ROLL                        = 0x0B42, ///< 6.2.0 20173
        SMSG_AE_LOOT_TARGETS                        = 0x0000, ///< (unused)
        SMSG_AE_LOOT_TARGETS_ACK                    = 0x0000, ///< (unused)
        SMSG_ITEM_BONUS_DEBUG                       = 0x0258, ///< 6.2.0 20173

        /// Bank
        SMSG_SHOW_BANK                              = 0x01C2, ///< 6.2.0 20173

        /// Rune
        SMSG_RESYNC_RUNES                           = 0x0806, ///< 6.2.0 20173
        SMSG_DEBUG_RUNE_REGEN                       = 0x0EB1, ///< 6.2.0 20173
        SMSG_ADD_RUNE_POWER                         = 0x0288, ///< 6.2.0 20173
        SMSG_CONVERT_RUNE                           = 0x0822, ///< 6.2.0 20173

        /// Group
        SMSG_PARTY_UPDATE                           = 0x0736, ///< 6.2.0 20173
        SMSG_PARTY_MEMBER_STATE_FULL                = 0x06CF, ///< 6.2.0 20173
        SMSG_PARTY_MEMBER_STATE_PARTIAL             = 0x0BC2, ///< 6.2.0 20173
        SMSG_PARTY_INVITE                           = 0x0208, ///< 6.2.0 20173
        SMSG_GROUP_DECLINE                          = 0x0E1F, ///< 6.2.0 20173
        SMSG_PARTY_COMMAND_RESULT                   = 0x045F, ///< 6.2.0 20173
        SMSG_GROUP_UNINVITE                         = 0x0126, ///< 6.2.0 20173
        SMSG_GROUP_NEW_LEADER                       = 0x009F, ///< 6.2.0 20173
        SMSG_MINIMAP_PING                           = 0x0CA0, ///< 6.2.0 20173
        SMSG_SET_LOOT_METHOD_FAILED                 = 0x0536, ///< 6.2.0 20173
        SMSG_RANDOM_ROLL                            = 0x0844, ///< 6.2.0 20173
        SMSG_SEND_RAID_TARGET_UPDATE_SINGLE         = 0x049C, ///< 6.2.0 20173
        SMSG_SEND_RAID_TARGET_UPDATE_ALL            = 0x001F, ///< 6.2.0 20173
        SMSG_READY_CHECK_COMPLETED                  = 0x0E84, ///< 6.2.0 20173
        SMSG_READY_CHECK_RESPONSE                   = 0x029B, ///< 6.2.0 20173
        SMSG_READY_CHECK_STARTED                    = 0x0010, ///< 6.2.0 20173
        SMSG_ROLL_POLL_INFORM                       = 0x0731, ///< 6.2.0 20173
        SMSG_ROLE_CHANGED_INFORM                    = 0x0E8C, ///< 6.2.0 20173
        SMSG_GROUP_DESTROYED                        = 0x04B5, ///< 6.2.0 20173

        /// Battleground
        SMSG_BATTLEFIELD_STATUS_QUEUED                      = 0x0888, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_STATUS_NONE                        = 0x0E22, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_STATUS_NEED_CONFIRMATION           = 0x06C8, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_STATUS_ACTIVE                      = 0x065F, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_STATUS_FAILED                      = 0x0525, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_STATUS_WAIT_FOR_GROUPS             = 0x0B26, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_PORT_DENIED                        = 0x0000, ///< (unused)
        SMSG_RATED_BATTLEFIELD_INFO                         = 0x0621, ///< 6.2.0 20173
        SMSG_BATTLEGROUND_PLAYER_JOINED                     = 0x00C8, ///< 6.2.0 20173
        SMSG_BATTLEGROUND_PLAYER_LEFT                       = 0x0018, ///< 6.2.0 20173
        SMSG_BATTLEGROUND_PLAYER_POSITIONS                  = 0x0C98, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_ENTERING                       = 0x028B, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE         = 0x0250, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_EJECT_PENDING                  = 0x0000, ///< (unused)
        SMSG_BATTLEFIELD_MGR_EJECTED                        = 0x0603, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                   = 0x0AD2, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_STATE_CHANGED                  = 0x0000, ///< (unused)
        SMSG_BFMGR_ENTRY_INVITE                             = 0x0FA2, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                   = 0x0000,
        SMSG_REQUEST_PVP_REWARDS_RESPONSE                   = 0x0820, ///< 6.2.0 20173
        SMSG_PVP_OPTIONS_ENABLED                            = 0x0B56, ///< 6.2.0 20173
        SMSG_PVPLOG_DATA                                    = 0x01C1, ///< 6.2.0 20173
        SMSG_ARENA_OPPONENT_SPECIALIZATIONS                 = 0x0E50, ///< 6.2.0 20173
        ...
        SMSG_CONQUEST_FORMULA_CONSTANTS                     = 0x0906, ///< 6.2.0 20173
        SMSG_PVP_SEASON                                     = 0x0CB2, ///< 6.2.0 20173
        SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPENENT  = 0x0000, ///< (unused)
        SMSG_SPIRIT_HEALER_CONFIRM                          = 0x0E4C, ///< 6.2.0 20173
        SMSG_AREA_SPIRIT_HEALER_TIME                        = 0x03D5, ///< 6.2.0 20173
        SMSG_BATTLEFIELD_LIST                               = 0x0454, ///< 6.2.0 20173
        SMSG_CHECK_WARGAME_ENTRY                            = 0x0BB2, ///< 6.2.0 20173

        /// Pet
        SMSG_PET_NAME_QUERY_RESPONSE                        = 0x064F, ///< 6.2.0 20173
        SMSG_PET_NAME_INVALID                               = 0x0D25, ///< 6.2.0 20173
        SMSG_PET_DISMISS_SOUND                              = 0x0BA2, ///< 6.2.0 20173
        SMSG_PET_GUIDS                                      = 0x06A0, ///< 6.2.0 20173
        SMSG_PET_MODE                                       = 0x0000, ///< (unused)
        SMSG_PET_SLOT_UPDATED                               = 0x0000, ///< (unused)
        SMSG_PET_STABLE_LIST                                = 0x0A48, ///< 6.2.0 20173
        SMSG_PET_ACTION_FEEDBACK                            = 0x0091, ///< 6.2.0 20173
        SMSG_PET_ACTION_SOUND                               = 0x0050, ///< 6.2.0 20173
        SMSG_PET_ADDED                                      = 0x0000, ///< (unused)
        SMSG_SET_PET_SPECIALIZATION                         = 0x0054, ///< 6.2.0 20173
        SMSG_STABLE_RESULT                                  = 0x0054, ///< 6.2.0 20173

        /// Pet Battle opcodes
        SMSG_BATTLE_PET_JOURNAL                             = 0x060F, ///< 6.2.0 20173
        SMSG_QUERY_PET_NAME_RESPONSE                        = 0x064F, ///< 6.2.0 20173
        ...
        SMSG_PET_BATTLE_SLOT_UPDATES                        = 0x0025, ///< 6.2.0 20173

        /// Instances
        SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT                     = 0x0B45, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT                  = 0x0214, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY                 = 0x0853, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_TIMER_START                     = 0x0D26, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START                 = 0x0CDF, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE              = 0x0648, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_START                           = 0x0094, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE                = 0x09A2, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_END                             = 0x0625, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION          = 0x084B, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED             = 0x06CC, ///< 6.2.0 20173
        SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x0B01, ///< 6.2.0 20173
        SMSG_INSTANCE_RESET                                     = 0x0E31, ///< 6.2.0 20173
        SMSG_INSTANCE_RESET_FAILED                              = 0x03D6, ///< 6.2.0 20173
        SMSG_RAID_INSTANCE_INFO                                 = 0x025F, ///< 6.2.0 20173
        SMSG_RAID_GROUP_ONLY                                    = 0x0ED8, ///< 6.2.0 20173
        SMSG_RAID_MARKERS_CHANGED                               = 0x0E5F, ///< 6.2.0 20173
        SMSG_INSTANCE_SAVE_CREATED                              = 0x00DB, ///< 6.2.0 20173
        SMSG_INSTANCE_GROUP_SIZE_CHANGED                        = 0x0B55, ///< 6.2.0 20173
        SMSG_ENCOUNTER_END                                      = 0x08DF, ///< 6.2.0 20173
        SMSG_ENCOUNTER_START                                    = 0x08D7, ///< 6.2.0 20173
        SMSG_BOSS_KILL_CREDIT                                   = 0x06C4, ///< 6.2.0 20173

        /// Scenarios
        SMSG_SCENARIO_POI                                       = 0x00CC, ///< 6.2.0 20173
        SMSG_SCENARIO_PROGRESS_UPDATE                           = 0x0AA5, ///< 6.2.0 20173
        SMSG_SCENARIO_STATE                                     = 0x0E35, ///< 6.2.0 20173

        /// Auction House
        SMSG_AUCTION_HELLO_RESPONSE                             = 0x0C5B, ///< 6.2.0 20173
        SMSG_AUCTION_BIDDER_LIST_RESULT                         = 0x04A0, ///< 6.2.0 20173
        SMSG_AUCTION_BIDDER_NOTIFICATION                        = 0x04DB, ///< 6.2.0 20173
        SMSG_AUCTION_BUYOUT_NOTIFICATION                        = 0x0636, ///< 6.2.0 20173
        SMSG_AUCTION_COMMAND_RESULT                             = 0x0B16, ///< 6.2.0 20173
        SMSG_AUCTION_CLOSED_NOTIFICATION                        = 0x0C18, ///< 6.2.0 20173
        SMSG_AUCTION_LIST_PENDING_SALES                         = 0x0EC3, ///< 6.2.0 20173
        SMSG_AUCTION_LIST_RESULT                                = 0x0847, ///< 6.2.0 20173
        SMSG_AUCTION_OWNER_LIST_RESULT                          = 0x0287, ///< 6.2.0 20173
        SMSG_AUCTION_OWNER_BID_NOTIFICATION                     = 0x0418, ///< 6.2.0 20173

        /// Mail
        SMSG_SEND_MAIL_RESULT                                   = 0x04B1, ///< 6.2.0 20173
        SMSG_MAIL_LIST_RESULT                                   = 0x025C, ///< 6.2.0 20173
        SMSG_RECEIVED_MAIL                                      = 0x06B5, ///< 6.2.0 20173
        SMSG_MAIL_QUERY_NEXT_TIME_RESULT                        = 0x01A2, ///< 6.2.0 20173

        /// Trainers
        SMSG_TRAINER_LIST                                       = 0x03C6, ///< 6.2.0 20173
        SMSG_TRAINER_SERVICE                                    = 0x0050, ///< 6.2.0 20173

        /// Void Storage
        SMSG_VOID_ITEM_SWAP_RESPONSE                            = 0x0004, ///< 6.2.0 20173
        SMSG_VOID_STORAGE_CONTENTS                              = 0x08D2, ///< 6.2.0 20173
        SMSG_VOID_STORAGE_FAILED                                = 0x008B, ///< 6.2.0 20173
        SMSG_VOID_STORAGE_TRANSFER_CHANGES                      = 0x00D5, ///< 6.2.0 20173
        SMSG_VOID_TRANSFER_RESULT                               = 0x0D35, ///< 6.2.0 20173

        /// Petition
        SMSG_PETITION_ALREADY_SIGNED                            = 0x0C60, ///< 6.2.0 20173
        SMSG_PETITION_SIGN_RESULTS                              = 0x00C8, ///< 6.2.0 20173
        SMSG_QUERY_PETITION_RESPONSE                            = 0x00A2, ///< 6.2.0 20173
        SMSG_PETITION_SHOW_LIST                                 = 0x0C08, ///< 6.2.0 20173
        SMSG_PETITION_SHOW_SIGNATURES                           = 0x0222, ///< 6.2.0 20173
        SMSG_TURN_IN_PETITION_RESULTS                           = 0x0C88, ///< 6.2.0 20173
        SMSG_PETITION_DECLINED                                  = 0x0000, ///< fake opcode

        /// Threat
        SMSG_THREAT_CLEAR                                       = 0x0C9C, ///< 6.2.0 20173
        SMSG_THREAT_REMOVE                                      = 0x0A83, ///< 6.2.0 20173
        SMSG_THREAT_UPDATE                                      = 0x0660, ///< 6.2.0 20173
        SMSG_HIGHEST_THREAT_UPDATE                              = 0x0B36, ///< 6.2.0 20173
        ...
        SMSG_GM_TICKET_SYSTEM_STATUS                            = 0x0ADF, ///< 6.2.0 20173
        ...
        SMSG_GM_TICKET_CASE_STATUS                              = 0x005F, ///< 6.2.0 20173

        /// Calendar
        SMSG_CALENDAR_CLEAR_PENDING_ACTION                      = 0x09C2, ///< 6.2.0 20173
        SMSG_CALENDAR_COMMAND_RESULT                            = 0x0722, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INITIAL_INVITE                      = 0x0C48, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE                              = 0x0284, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_ALERT                        = 0x0C93, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_NOTES                        = 0x0C53, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT                  = 0x0243, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_REMOVED                      = 0x0484, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT                = 0x00D8, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_STATUS                       = 0x0235, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT                 = 0x088C, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_MODERATOR_STATUS                    = 0x0735, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_REMOVED_ALERT                       = 0x09B6, ///< 6.2.0 20173
        SMSG_CALENDAR_EVENT_UPDATED_ALERT                       = 0x0A87, ///< 6.2.0 20173
        SMSG_CALENDAR_RAID_LOCKOUT_ADDED                        = 0x0232, ///< 6.2.0 20173
        SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                      = 0x0C1B, ///< 6.2.0 20173
        SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                      = 0x0CC4, ///< 6.2.0 20173
        SMSG_CALENDAR_SEND_CALENDAR                             = 0x088B, ///< 6.2.0 20173
        SMSG_CALENDAR_SEND_EVENT                                = 0x05B2, ///< 6.2.0 20173
        SMSG_CALENDAR_SEND_NUM_PENDING                          = 0x08B5, ///< 6.2.0 20173

        /// Warden
        SMSG_WARDEN_DATA                                        = 0x0000, ///< Autoparser error - Opcode not found. Old Opcode: 0x0BEC

        /// Challenges
        SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT              = 0x0453, ///< 6.2.0 20173
        SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE                    = 0x0810, ///< 6.2.0 20173
        SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD                   = 0x0E83, ///< 6.2.0 20173
        SMSG_CHALLENGE_MODE_ALL_MAP_STATS                       = 0x0A22, ///< 6.2.0 20173
        SMSG_CHALLENGE_MODE_START                               = 0x0000, ///< This opcode is wrong and not existing
        SMSG_CHALLENGE_MODE_COMPLETE                            = 0x068B, ///< 6.2.0 20173
        SMSG_CHALLENGE_MOD_REWARDS                              = 0x0000, ///< (NYI)

        /// BlackMarket
        SMSG_BLACK_MARKET_OPEN_RESULT                           = 0x0A58, ///< 6.2.0 20173
        SMSG_BLACK_MARKET_OUTBID                                = 0x0226, ///< 6.2.0 20173
        SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT                  = 0x0A14, ///< 6.2.0 20173
        SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT                    = 0x0921, ///< 6.2.0 20173
        SMSG_BLACK_MARKET_WON                                   = 0x01C5, ///< 6.2.0 20173

        /// Garrison
        SMSG_OPEN_SHIPMENT_NPCFROM_GOSSIP                       = 0x0A97, ///< 6.2.0 20173
        SMSG_GET_SHIPMENT_INFO_RESPONSE                         = 0x024F, ///< 6.2.0 20173
        SMSG_GET_SHIPMENTS                                      = 0x089C, ///< 6.2.0 20173
        SMSG_CREATE_SHIPMENT_RESPONSE                           = 0x0220, ///< 6.2.0 20173

        /// Twitter
        SMSG_REQUEST_TWITTER_STATUS_RESPONSE                    = 0x0000,
        SMSG_OAUTH_SAVED_DATA                                   = 0x04DA, ///< 6.2.0 20173

        /// Toys
        SMSG_ACCOUNT_TOYS_UPDATE                                = 0x0ACF, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamGuild
        /// Petition
        SMSG_PETITION_RENAME                        = 0x08AB, ///< 6.2.0 20173

        /// Guild Finder
        SMSG_LFGUILD_BROWSE                         = 0x08FC, ///< 6.2.0 20173
        SMSG_LFGUILD_APPLICATIONS                   = 0x04EB, ///< 6.2.0 20173
        SMSG_LFGUILD_APPLICATIONS_LIST_CHANGED      = 0x00FC, ///< 6.2.0 20173
        SMSG_LFGUILD_COMMAND_RESULT                 = 0x0000, ///< (unused)
        SMSG_LFGUILD_RECRUITS                       = 0x08E4, ///< 6.2.0 20173
        SMSG_LFGUILD_POST                           = 0x02B4, ///< 6.2.0 20173
        SMSG_LFGUILD_APPLICANT_LIST_CHANGED         = 0x00FC, ///< 6.2.0 20173

        /// Bank
        SMSG_GUILD_RANKS                            = 0x06FB, ///< 6.2.0 20173
        SMSG_GUILD_BANK_LOG_QUERY_RESULT            = 0x06EB, ///< 6.2.0 20173
        SMSG_GUILD_BANK_REMAINING_WITHDRAW_MONEY    = 0x0CA4, ///< 6.2.0 20173
        SMSG_GUILD_BANK_QUERY_TEXT_RESULT           = 0x02E4, ///< 6.2.0 20173
        SMSG_GUILD_BANK_QUERY_RESULTS               = 0x06FC, ///< 6.2.0 20173
        SMSG_GUILD_PERMISSIONS_QUERY_RESULTS        = 0x00EC, ///< 6.2.0 20173

        /// Achievement
        SMSG_GUILD_ACHIEVEMENT_DELETED              = 0x06AC, ///< 6.2.0 20173
        SMSG_GUILD_ACHIEVEMENT_MEMBERS              = 0x0000, ///< (unused)
        SMSG_GUILD_ACHIEVEMENT_EARNED               = 0x01A1, ///< 6.2.0 20173
        SMSG_GUILD_CRITERIA_UPDATE                  = 0x0000, ///< (unused)
        SMSG_GUILD_CRITERIA_DELETED                 = 0x00AB, ///< 6.2.0 20173
        SMSG_ALL_GUILD_ACHIEVEMENTS                 = 0x08E3, ///< 6.2.0 20173

        /// Info
        SMSG_GUILD_ROSTER                           = 0x04B3, ///< 6.2.0 20173
        SMSG_GUILD_ROSTER_UPDATE                    = 0x0000, ///< (unused)
        SMSG_QUERY_GUILD_INFO_RESPONSE              = 0x04A4, ///< 6.2.0 20173
        SMSG_GUILD_MEMBER_UPDATE_NOTE               = 0x0000, ///< (unused)
        SMSG_GUILD_REWARDS_LIST                     = 0x0AF3, ///< 6.2.0 20173
        SMSG_GUILD_SEND_RANK_CHANGE                 = 0x00B4, ///< 6.2.0 20173
        SMSG_GUILD_CHALLENGE_UPDATED                = 0x02AB, ///< 6.2.0 20173
        SMSG_GUILD_MEMBER_RECIPES                   = 0x0000, ///< (unused)
        SMSG_GUILD_INVITE_EXPIRED                   = 0x0000, ///< (unused)
        SMSG_GUILD_COMMAND_RESULT                   = 0x06EC, ///< 6.2.0 20173
        SMSG_GUILD_CHALLENGE_COMPLETED              = 0x00BC, ///< 6.2.0 20173
        SMSG_GUILD_REPUTATION_REACTION_CHANGED      = 0x00E3, ///< 6.2.0 20173
        SMSG_GUILD_KNOWN_RECIPES                    = 0x04BB, ///< 6.2.0 20173
        SMSG_GUILD_MEMBER_DAILY_RESET               = 0x0AFB, ///< 6.2.0 20173
        ...
        SMSG_GUILD_INVITE                           = 0x08BB, ///< 6.2.0 20173
        SMSG_GUILD_INVITE_DECLINED                  = 0x0000, ///< (unused)
        SMSG_GUILD_PARTY_STATE                      = 0x0ABC, ///< 6.2.0 20173
        SMSG_GUILD_MEMBERS_WITH_RECIPE              = 0x0000, ///< (unused)
        SMSG_GUILD_MOVE_STARTING                    = 0x0000, ///< (unused)
        SMSG_GUILD_MOVED                            = 0x0000, ///< (unused)
        SMSG_GUILD_NEWS                             = 0x00A3, ///< 6.2.0 20173
        SMSG_GUILD_NEWS_DELETED                     = 0x0000, ///< (unused)
        SMSG_PLAYER_TABAR_VENDOR_SHOW               = 0x0E48, ///< 6.2.0 20173
        SMSG_PLAYER_SAVE_GUILD_EMBLEM               = 0x02EB, ///< 6.2.0 20173

        /// Event system
        SMSG_GUILD_EVENT_NEW_LEADER                 = 0x02F3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_PRESENCE_CHANGE            = 0x06F4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_PLAYER_JOINED              = 0x06E4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_PLAYER_LEFT                = 0x06A4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_RANKS_UPDATED              = 0x00F4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_RANK_CHANGED               = 0x08A3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_LOG_QUERY_RESULTS          = 0x08B4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_MOTD                       = 0x02A3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_DISBANDED                  = 0x06F3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_TAB_ADDED                  = 0x0AA4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_TAB_MODIFIED               = 0x04A3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_TAB_DELETED                = 0x04B4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_TAB_TEXT_CHANGED           = 0x08F4, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_BANK_CONTENTS_CHANGED      = 0x00F3, ///< 6.2.0 20173
        SMSG_GUILD_EVENT_BANK_MONEY_CHANGED         = 0x0AF4, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamChat
        ...
        /// Misc
        SMSG_SERVER_FIRST_ACHIEVEMENT               = 0x154A, ///< 6.2.0 20173
        SMSG_RAID_INSTANCE_MESSAGE                  = 0x171A, ///< 6.2.0 20173
        SMSG_MOTD                                   = 0x1649, ///< 6.2.0 20173
        SMSG_EXPECTED_SPAM_RECORDS                  = 0x0000, ///< (unused)
        SMSG_DEFENSE_MESSAGE                        = 0x0000, ///< (unused)
        SMSG_ZONE_UNDER_ATTACK                      = 0x1419, ///< 6.2.0 20173
        SMSG_WHO                                    = 0x16CA, ///< 6.2.0 20173

        /// Chat
        SMSG_CHAT_SERVER_MESSAGE                    = 0x1D49, ///< 6.2.0 20173
        SMSG_CHAT_RESTRICTED                        = 0x16DA, ///< 6.2.0 20173
        SMSG_CHAT_RECONNECT                         = 0x0000, ///< (unused)
        SMSG_CHAT_PLAYER_NOTFOUND                   = 0x17D9, ///< 6.2.0 20173
        SMSG_CHAT_PLAYER_AMBIGUOUS                  = 0x1459, ///< 6.2.0 20173
        ...
        SMSG_CHAT                                   = 0x144A, ///< 6.2.0 20173

        /// Channel
        SMSG_CHANNEL_NOTIFY_LEFT                    = 0x145A, ///< 6.2.0 20173
        SMSG_CHANNEL_NOTIFY_JOINED                  = 0x1519, ///< 6.2.0 20173
        SMSG_CHANNEL_NOTIFY                         = 0x1699, ///< 6.2.0 20173
        SMSG_CHANNEL_LIST                           = 0x14DA, ///< 6.2.0 20173
        SMSG_USERLIST_ADD                           = 0x1C59, ///< 6.2.0 20173
        SMSG_USERLIST_REMOVE                        = 0x1D5A, ///< 6.2.0 20173
        SMSG_USERLIST_UPDATE                        = 0x1489, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamMove
        /// Move speeds
        SMSG_MOVE_SET_RUN_SPEED                     = 0x1C04, ///< 6.2.0 20173
        SMSG_MOVE_SET_RUN_BACK_SPEED                = 0x1CC8, ///< 6.2.0 20173
        SMSG_MOVE_SET_SWIM_SPEED                    = 0x10D3, ///< 6.2.0 20173
        SMSG_MOVE_SET_SWIM_BACK_SPEED               = 0x1227, ///< 6.2.0 20173
        SMSG_MOVE_SET_FLIGHT_SPEED                  = 0x1C43, ///< 6.2.0 20173
        SMSG_MOVE_SET_FLIGHT_BACK_SPEED             = 0x0ED6, ///< 6.2.0 20173
        SMSG_MOVE_SET_WALK_SPEED                    = 0x1954, ///< 6.2.0 20173
        SMSG_MOVE_SET_TURN_RATE                     = 0x032C, ///< 6.2.0 20173
        SMSG_MOVE_SET_PITCH_RATE                    = 0x0F30, ///< 6.2.0 20173
        SMSG_MOVE_KNOCK_BACK                        = 0x19D3, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_RUN_SPEED                  = 0x0630, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_RUN_BACK_SPEED             = 0x0623, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_SWIM_SPEED                 = 0x0C64, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_SWIM_BACK_SPEED            = 0x0E92, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_FLIGHT_SPEED               = 0x1104, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_FLIGHT_BACK_SPEED          = 0x0C51, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_WALK_SPEED                 = 0x1188, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_TURN_RATE                  = 0x0196, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_PITCH_RATE                 = 0x0423, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_KNOCK_BACK                 = 0x1D18, ///< 6.2.0 20173

        /// Player
        SMSG_MOVE_UPDATE                                    = 0x1325, ///< 6.2.0 20173
        SMSG_MOVE_TELEPORT                                  = 0x1157, ///< 6.2.0 20173
        SMSG_MOVE_UPDATE_TELEPORT                           = 0x1958, ///< 6.2.0 20173
        SMSG_MOVE_ROOT                                      = 0x0AC6, ///< 6.2.0 20173
        SMSG_MOVE_UNROOT                                    = 0x1271, ///< 6.2.0 20173
        SMSG_MOVE_WATER_WALK                                = 0x1508, ///< 6.2.0 20173
        SMSG_MOVE_LAND_WALK                                 = 0x0C82, ///< 6.2.0 20173
        SMSG_MOVE_FEATHER_FALL                              = 0x1D04, ///< 6.2.0 20173
        SMSG_MOVE_NORMAL_FALL                               = 0x1513, ///< 6.2.0 20173
        SMSG_MOVE_SET_ACTIVE_MOVER                          = 0x0ED1, ///< 6.2.0 20173
        SMSG_MOVE_SET_CAN_FLY                               = 0x0824, ///< 6.2.0 20173
        SMSG_MOVE_UNSET_CAN_FLY                             = 0x0A81, ///< 6.2.0 20173
        SMSG_MOVE_SET_HOVER                                 = 0x1054, ///< 6.2.0 20173
        SMSG_MOVE_UNSET_HOVER                               = 0x0082, ///< 6.2.0 20173
        SMSG_MOVE_SET_CAN_TURN_WHILE_FALLING                = 0x1488, ///< 6.2.0 20173
        SMSG_MOVE_UNSET_CAN_TURN_WHILE_FALLING              = 0x0B2F, ///< 6.2.0 20173
        SMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY   = 0x1143, ///< 6.2.0 20173
        SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x1D84, ///< 6.2.0 20173
        SMSG_MOVE_SET_VEHICLE_REC_ID                        = 0x1276, ///< 6.2.0 20173
        SMSG_MOVE_SET_COLLISION_HEIGHT                      = 0x1918, ///< 6.2.0 20173
        SMSG_APPLY_MOVEMENT_FORCE                           = 0x1C53, ///< 6.2.0 20173
        SMSG_UNAPPLY_MOVEMENT_FORCE                         = 0x19C3, ///< 6.2.0 20173
        ...
        /// Creature
        SMSG_MONSTER_MOVE                           = 0x0C28, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_RUN_SPEED              = 0x12E1, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED         = 0x1058, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_SWIM_SPEED             = 0x1588, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED        = 0x1D17, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED           = 0x18C7, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED      = 0x1264, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_WALK_SPEED             = 0x1954, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_TURN_RATE              = 0x1557, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_PITCH_RATE             = 0x1908, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_ROOT                       = 0x12E3, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_UNROOT                     = 0x0141, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_GRAVITY_DISABLE            = 0x0827, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_GRAVITY_ENABLE             = 0x12F5, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_COLLISION_DISABLE          = 0x0000, ///< (unused)
        SMSG_SPLINE_MOVE_COLLISION_ENABLE           = 0x0000, ///< (unused)
        SMSG_SPLINE_MOVE_SET_FEATHER_FALL           = 0x1335, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_NORMAL_FALL            = 0x0281, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_HOVER                  = 0x0E91, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_UNSET_HOVER                = 0x0627, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_WATER_WALK             = 0x0C45, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_LAND_WALK              = 0x0B24, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_START_SWIM                 = 0x0000, ///< (unused)
        SMSG_SPLINE_MOVE_STOP_SWIM                  = 0x0000, ///< (unused)
        SMSG_SPLINE_MOVE_SET_RUN_MODE               = 0x0C91, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_WALK_MODE              = 0x12F1, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_SET_FLYING                 = 0x1048, ///< 6.2.0 20173
        SMSG_SPLINE_MOVE_UNSET_FLYING               = 0x1483, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamSpell
        ...
        SMSG_AURA_UPDATE                            = 0x0ABD, ///< 6.2.0 20173

        /// Misc
        SMSG_CHEAT_IGNORE_DIMISHING_RETURNS         = 0x0000, ///< (unused)
        SMSG_DISPEL_FAILED                          = 0x057E, ///< 6.2.0 20173
        SMSG_INCREASE_CAST_TIME_FOR_SPELL           = 0x0000, ///< (unused)
        SMSG_MIRROR_IMAGE_COMPONENTED_DATA          = 0x092D, ///< 6.2.0 20173
        ...
        SMSG_CAST_FAILED                            = 0x066E, ///< 6.2.0 20173
        SMSG_SPELL_FAILURE                          = 0x00EA, ///< 6.2.0 20173
        SMSG_SPELL_FAILED_OTHER                     = 0x0BAA, ///< 6.2.0 20173
        SMSG_PET_CAST_FAILED                        = 0x07FE, ///< 6.2.0 20173
        SMSG_ITEM_COOLDOWN                          = 0x0A32, ///< 6.2.0 20173
        SMSG_MODIFY_COOLDOWN                        = 0x0892, ///< 6.2.0 20173
        SMSG_COOLDOWN_CHEAT                         = 0x0000, ///< (unused)
        SMSG_PET_TAME_FAILURE                       = 0x09D1, ///< 6.2.0 20173
        SMSG_FEIGN_DEATH_RESISTED                   = 0x0DB5, ///< 6.2.0 20173
        SMSG_NOTIFY_DEST_LOC_SPELL_CAST             = 0x0000, ///< (unused)
        SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA   = 0x081C, ///< 6.2.0 20173
        SMSG_SET_VEHICLE_REC_ID                     = 0x0952, ///< 6.2.0 20173
        SMSG_COOLDOWN_EVENT                         = 0x021F, ///< 6.2.0 20173
        SMSG_DISMOUNT                               = 0x02DF, ///< 6.2.0 20173
        SMSG_DISMOUNTRESULT                         = 0x0000, ///< (unused)
        SMSG_MOUNT_RESULT                           = 0x0AB1, ///< 6.2.0 20173

        /// Spell Book / Bar
        SMSG_UPDATE_WEEKLY_SPELL_USAGE              = 0x0000, ///< (unused)
        SMSG_WEEKLY_SPELL_USAGE                     = 0x0000, ///< (unused)
        SMSG_SEND_KNOWN_SPELLS                      = 0x096E, ///< 6.2.0 20173
        SMSG_SEND_SPELL_CHARGES                     = 0x0BF9, ///< 6.2.0 20173
        SMSG_SEND_SPELL_HISTORY                     = 0x0000, ///< (unused)
        SMSG_SEND_UNLEARN_SPELLS                    = 0x0000, ///< (unused)
        SMSG_CLEAR_ALL_SPELL_CHARGES                = 0x016D, ///< 6.2.0 20173
        SMSG_CLEAR_COOLDOWN                         = 0x0ED7, ///< 6.2.0 20173
        SMSG_CLEAR_COOLDOWNS                        = 0x05BE, ///< 6.2.0 20173
        SMSG_CATEGORY_COOLDOWN                      = 0x0C7E, ///< 6.2.0 20173
        SMSG_CLEAR_SPELL_CHARGES                    = 0x08A9, ///< 6.2.0 20173
        SMSG_SET_FLAT_SPELL_MODIFIER                = 0x0AE9, ///< 6.2.0 20173
        SMSG_SET_PCT_SPELL_MODIFIER                 = 0x01BA, ///< 6.2.0 20173
        SMSG_SET_SPELL_CHARGES                      = 0x002D, ///< 6.2.0 20173
        SMSG_LEARNED_SPELL                          = 0x092A, ///< 6.2.0 20173
        SMSG_UNLEARNED_SPELLS                       = 0x04B9, ///< 6.2.0 20173

        /// Casting
        SMSG_SPELL_CHANNEL_START                    = 0x07BD, ///< 6.2.0 20173
        SMSG_SPELL_COOLDOWN                         = 0x0569, ///< 6.2.0 20173
        SMSG_SPELL_CHANNEL_UPDATE                   = 0x067E, ///< 6.2.0 20173
        SMSG_SPELL_DAMAGE_SHIELD                    = 0x07B9, ///< 6.2.0 20173
        SMSG_SPELL_DELAYED                          = 0x012E, ///< 6.2.0 20173
        SMSG_SPELL_GO                               = 0x046E, ///< 6.2.0 20173
        SMSG_SPELL_MULTISTRIKE_EFFECT               = 0x0000, ///< (unused)
        SMSG_SPELL_OR_DAMAGE_IMMUNE                 = 0x00BE, ///< 6.2.0 20173
        SMSG_SPELL_START                            = 0x007D, ///< 6.2.0 20173
        SMSG_SPELL_UPDATE_CHAIN_TARGETS             = 0x0000, ///< (unused)

        /// Logging
        SMSG_SPELL_DISPELL_LOG                      = 0x04AA, ///< 6.2.0 20173
        SMSG_SPELL_ENERGIZE_LOG                     = 0x05EE, ///< 6.2.0 20173
        SMSG_SPELL_EXECUTE_LOG                      = 0x0C39, ///< 6.2.0 20173
        SMSG_SPELL_NON_MELEE_DAMAGE_LOG             = 0x062E, ///< 6.2.0 20173
        SMSG_SPELL_HEAL_LOG                         = 0x02A9, ///< 6.2.0 20173
        SMSG_SPELL_INSTAKILL_LOG                    = 0x02FA, ///< 6.2.0 20173
        SMSG_SPELL_INTERRUPT_LOG                    = 0x05A9, ///< 6.2.0 20173
        SMSG_SPELL_MISS_LOG                         = 0x07BE, ///< 6.2.0 20173
        SMSG_ENVIRONMENTAL_DAMAGE_LOG               = 0x093D, ///< 6.2.0 20173
        SMSG_SPELL_PERIODIC_AURA_LOG                = 0x06FA, ///< 6.2.0 20173
        ...
        /// Pet
        SMSG_PET_SPELLS_MESSAGE                     = 0x016A, ///< 6.2.0 20173
        SMSG_PET_UNLEARNED_SPELLS                   = 0x06BE, ///< 6.2.0 20173
        SMSG_PET_LEARNED_SPELLS                     = 0x08B9, ///< 6.2.0 20173

        /// Visuals
        SMSG_PLAY_ORPHAN_SPELL_VISUAL               = 0x04FE, ///< 6.2.0 20173
        SMSG_CANCEL_ORPHAN_SPELL_VISUAL             = 0x01BD, ///< 6.2.0 20173
        SMSG_PLAY_SPELL_VISUAL                      = 0x002E, ///< 6.2.0 20173
        SMSG_CANCEL_SPELL_VISUAL                    = 0x006D, ///< 6.2.0 20173
        SMSG_PLAY_SPELL_VISUAL_KIT                  = 0x0B3E, ///< 6.2.0 20173
        SMSG_CANCEL_SPELL_VISUAL_KIT                = 0x0BFA, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamQuest
        /// Quest log
        SMSG_QUERY_QUEST_INFO_RESPONSE              = 0x0C09, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_FAILED_TIMER              = 0x0919, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_FAILED                    = 0x044A, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_COMPLETE                  = 0x1344, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_ADD_PVP_CREDIT            = 0x1203, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_ADD_CREDIT_SIMPLE         = 0x1218, ///< 6.2.0 20173
        SMSG_QUEST_UPDATE_ADD_CREDIT                = 0x005E, ///< 6.2.0 20173
        SMSG_QUEST_PUSH_RESULT                      = 0x035A, ///< 6.2.0 20173
        SMSG_QUEST_POIQUERY_RESPONSE                = 0x0409, ///< 6.2.0 20173
        SMSG_QUEST_LOG_FULL                         = 0x06CE, ///< 6.2.0 20173
        SMSG_IS_QUEST_COMPLETE_RESPONSE             = 0x0D0A, ///< 6.2.0 20173
        SMSG_QUEST_FORCE_REMOVED                    = 0x085A, ///< 6.2.0 20173
        SMSG_QUEST_CONFIRM_ACCEPT                   = 0x0589, ///< 6.2.0 20173
        SMSG_QUEST_COMPLETION_NPCRESPONSE           = 0x0E8A, ///< 6.2.0 20173
        SMSG_DAILY_QUESTS_RESET                     = 0x090A, ///< 6.2.0 20173

        /// Quest giver
        SMSG_QUEST_GIVER_STATUS_MULTIPLE            = 0x000D, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_STATUS                     = 0x084D, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_REQUEST_ITEMS              = 0x06CA, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_QUEST_LIST_MESSAGE         = 0x05C9, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_QUEST_FAILED               = 0x040E, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_QUEST_DETAILS              = 0x015D, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_QUEST_COMPLETE             = 0x021A, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_OFFER_REWARD_MESSAGE       = 0x0949, ///< 6.2.0 20173
        SMSG_QUEST_GIVER_INVALID_QUEST              = 0x0689, ///< 6.2.0 20173

        /// Gossip
        SMSG_GOSSIP_MESSAGE                         = 0x0E0A, ///< 6.2.0 20173
        SMSG_GOSSIP_COMPLETE                        = 0x0D89, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamLFG
        /// LFG
        SMSG_LFG_BOOT_PLAYER                              = 0x0611, ///< 6.2.0 20173
        SMSG_LFG_DISABLED                                 = 0x0C6C, ///< 6.2.0 20173
        SMSG_LFG_JOIN_RESULT                              = 0x0363, ///< 6.2.0 20173
        SMSG_LFG_OFFER_CONTINUE                           = 0x046B, ///< 6.2.0 20173
        SMSG_LFG_OPEN_FROM_GOSSIP                         = 0x0000, ///< (unused)
        SMSG_LFG_PARTY_INFO                               = 0x0256, ///< 6.2.0 20173
        SMSG_LFG_PLAYER_INFO                              = 0x0356, ///< 6.2.0 20173
        SMSG_LFG_PLAYER_REWARD                            = 0x066B, ///< 6.2.0 20173
        SMSG_LFG_PROPOSAL_UPDATE                          = 0x0D6B, ///< 6.2.0 20173
        SMSG_LFG_QUEUE_STATUS                             = 0x0255, ///< 6.2.0 20173
        SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x0368, ///< 6.2.0 20173
        SMSG_LFG_ROLE_CHOSEN                              = 0x066F, ///< 6.2.0 20173
        SMSG_LFG_SEARCH_RESULT                            = 0x0000, ///< (unused)
        SMSG_LFG_SLOT_INVALID                             = 0x0000, ///< (unused)
        SMSG_LFG_TELEPORT_DENIED                          = 0x0364, ///< 6.2.0 20173
        SMSG_LFG_UPDATE_LIST                              = 0x0000, ///<
        SMSG_LFG_UPDATE_PARTY                             = 0x0000,
        SMSG_LFG_UPDATE_PLAYER                            = 0x0000,
        SMSG_LFG_UPDATE_SEARCH                            = 0x0000,
        SMSG_LFG_UPDATE_STATUS                            = 0x076B, ///< 6.2.0 20173
        SMSG_LFG_UPDATE_STATUS_NONE                       = 0x0000,
        SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x0000,

        /// LFG List
        SMSG_LFG_LIST_JOIN_RESULT                         = 0x0252, ///< 6.2.0 20173
        SMSG_LFG_LIST_UPDATE_BLACKLIST                    = 0x086C, ///< 6.2.0 20173
        SMSG_LFG_LIST_UPDATE_STATUS                       = 0x0241, ///< 6.2.0 20173
        SMSG_LFG_LIST_SEARCH_RESULT                       = 0x052C, ///< 6.2.0 20173
    #pragma endregion
    ...
    #pragma region JamGarrison
        SMSG_GET_GARRISON_INFO_RESULT                                   = 0x0B75, ///< 6.2.0 20173
        SMSG_GARRISON_PLOT_PLACED                                       = 0x0172, ///< 6.2.0 20173
        SMSG_GARRISON_PLOT_REMOVED                                      = 0x0866, ///< 6.2.0 20173
        SMSG_GARRISON_PLACE_BUILDING_RESULT                             = 0x08F1, ///< 6.2.0 20173
        SMSG_GARRISON_BUILDING_REMOVED                                  = 0x04F5, ///< 6.2.0 20173
        SMSG_GARRISON_LEARN_SPECIALIZATION_RESULT                       = 0x0000,
        SMSG_GARRISON_BUILDING_SET_ACTIVE_SPECIALIZATION_RESULT         = 0x0000,
        SMSG_GARRISON_LEARN_BLUEPRINT_RESULT                            = 0x0176, ///< 6.2.0 20173
        SMSG_GARRISON_BLUEPRINT_AND_SPECIALIZATION_DATA                 = 0x05F5, ///< 6.2.0 20173
        SMSG_GARRISON_GET_BUILDINGS_DATA                                = 0x0275, ///< 6.2.0 20173
        SMSG_GARRISON_REMOTE_INFO                                       = 0x01F5, ///< 6.2.0 20173
        SMSG_GARRISON_BUILDING_ACTIVATED                                = 0x0662, ///< 6.2.0 20173
        SMSG_GARRISON_UPGRADE_RESULT                                    = 0x0000,
        SMSG_GARRISON_ADD_FOLLOWER_RESULT                               = 0x05E2, ///< 6.2.0 20173
        SMSG_GARRISON_REMOVE_FOLLOWER_RESULT                            = 0x0000,
        SMSG_GARRISON_LIST_FOLLOWERS_CHEAT_RESULT                       = 0x0000,
        SMSG_GARRISON_UPDATE_FOLLOWER_ACTIVATION_COUNT                  = 0x0775, ///< 6.2.0 20173
        SMSG_GARRISON_UPDATE_FOLLOWER                                   = 0x0AE2, ///< 6.2.0 20173
        SMSG_GARRISON_FOLLOWER_CHANGED_XP                               = 0x04E1, ///< 6.2.0 20173
        SMSG_GARRISON_FOLLOWER_CHANGED_ITEM_LEVEL                       = 0x0000,
        SMSG_GARRISON_ADD_MISSION_RESULT                                = 0x0366, ///< 6.2.0 20173
        SMSG_GARRISON_START_MISSION_RESULT                              = 0x07E6, ///< 6.2.0 20173
        SMSG_GARRISON_COMPLETE_MISSION_RESULT                           = 0x01E6, ///< 6.2.0 20173
        SMSG_GARRISON_MISSION_BONUS_ROLL_RESULT                         = 0x01F2, ///< 6.2.0 20173
        ...
        SMSG_GARRISON_OPEN_MISSION_NPC                                  = 0x09F5, ///< 6.2.0 20173
        SMSG_GARRISON_REQUEST_UPGRADEABLE_RESULT                        = 0x0566, ///< 6.2.0 20173
        SMSG_GARRISON_OPEN_TRADESKILL_NPC                               = 0x00E2, ///< 6.2.0 20173
    #pragma endregion
    ...
    CMSG_QUERY_COUNTDOWN_TIMER                  = 0x0000, ///<
