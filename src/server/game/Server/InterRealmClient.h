...
class InterRealmClient
{
    public:
        ...
        void Handle_AccountSpells(WorldPacket& recvPacket);
        void Handle_CharacterSkills(WorldPacket& recvPacket);
        ...
        void SendBattlefieldLeave(uint64 targetGuid, uint8 flags);
