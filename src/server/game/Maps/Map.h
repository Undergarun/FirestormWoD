...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        bool IsRaidOrHeroicDungeon() const { return IsRaid() || (i_spawnMode == HEROIC_5_DIFFICULTY || i_spawnMode == LEGACY_MAN25_DIFFICULTY || i_spawnMode == LEGACY_MAN25_DIFFICULTY || i_spawnMode == LEGACY_MAN10_DIFFICULTY || i_spawnMode == HEROIC_DIFFICULTY || i_spawnMode == MAN40_DIFFICULTY || i_spawnMode == HEROIC_DIFFICULTY); }
