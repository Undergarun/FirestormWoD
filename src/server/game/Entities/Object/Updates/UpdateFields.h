...
enum EUnitFields
{
    ...
    UNIT_FIELD_MIN_ITEM_LEVEL = 187, // SIZE:1
    UNIT_FIELD_MAX_ITEM_LEVEL = 188, // SIZE:1
    UNIT_FIELD_WILD_BATTLE_PET_LEVEL = 189, // SIZE:1
    UNIT_FIELD_BATTLE_PET_COMPANION_NAME_TIMESTAMP = 190, // SIZE:1
    UNIT_FIELD_INTERACT_SPELL_ID = 191, // SIZE:1
    UNIT_FIELD_STATE_SPELL_VISUAL_ID = 192, // SIZE:1
    UNIT_FIELD_STATE_ANIM_ID = 193, // SIZE:1
    UNIT_FIELD_STATE_ANIM_KIT_ID = 194, // SIZE:1
    UNIT_FIELD_STATE_WORLD_EFFECT_ID = 195, // SIZE:4
    UNIT_FIELD_SCALE_DURATION = 199, // SIZE:1
    UNIT_FIELD_LOOKS_LIKE_MOUNT_ID = 200, // SIZE:1
    UNIT_FIELD_LOOKS_LIKE_CREATURE_ID = 201, // SIZE:1
    UNIT_END = 202
};
...
enum EPlayerFields
{
    PLAYER_FIELD_DUEL_ARBITER = 202, // SIZE:4
    PLAYER_FIELD_WOW_ACCOUNT = 206, // SIZE:4
    PLAYER_FIELD_PLAYER_FLAGS = 210, // SIZE:1
    PLAYER_FIELD_PLAYER_FLAGS_EX = 211, // SIZE:1
    PLAYER_FIELD_GUILD_RANK_ID = 212, // SIZE:1
    PLAYER_FIELD_GUILD_DELETE_DATE = 213, // SIZE:1
    PLAYER_FIELD_GUILD_LEVEL = 214, // SIZE:1
    PLAYER_FIELD_HAIR_COLOR_ID = 215, // SIZE:1
    PLAYER_FIELD_REST_STATE = 216, // SIZE:1
    PLAYER_FIELD_ARENA_FACTION = 217, // SIZE:1
    PLAYER_FIELD_DUEL_TEAM = 218, // SIZE:1
    PLAYER_FIELD_GUILD_TIME_STAMP = 219, // SIZE:1
    PLAYER_FIELD_QUEST_LOG = 220, // SIZE:750
    PLAYER_FIELD_VISIBLE_ITEMS = 970, // SIZE:57
    PLAYER_FIELD_PLAYER_TITLE = 1027, // SIZE:1
    PLAYER_FIELD_FAKE_INEBRIATION = 1028, // SIZE:1
    PLAYER_FIELD_VIRTUAL_PLAYER_REALM = 1029, // SIZE:1
    PLAYER_FIELD_CURRENT_SPEC_ID = 1030, // SIZE:1
    PLAYER_FIELD_TAXI_MOUNT_ANIM_KIT_ID = 1031, // SIZE:1
    PLAYER_FIELD_AVG_ITEM_LEVEL_TOTAL = 1032, // SIZE:1
    PLAYER_FIELD_AVG_ITEM_LEVEL_EQUIPPED = 1033, // SIZE:1
    PLAYER_FIELD_CURRENT_BATTLE_PET_BREED_QUALITY = 1034, // SIZE:1
    PLAYER_FIELD_INV_SLOTS = 1035, // SIZE:736
    PLAYER_FIELD_FARSIGHT_OBJECT = 1771, // SIZE:4
    PLAYER_FIELD_KNOWN_TITLES = 1775, // SIZE:10
    PLAYER_FIELD_COINAGE = 1785, // SIZE:2
    PLAYER_FIELD_XP = 1787, // SIZE:1
    PLAYER_FIELD_NEXT_LEVEL_XP = 1788, // SIZE:1
    PLAYER_FIELD_SKILL = 1789, // SIZE:448
    PLAYER_FIELD_CHARACTER_POINTS = 2237, // SIZE:1
    PLAYER_FIELD_MAX_TALENT_TIERS = 2238, // SIZE:1
    PLAYER_FIELD_TRACK_CREATURE_MASK = 2239, // SIZE:1
    PLAYER_FIELD_TRACK_RESOURCE_MASK = 2240, // SIZE:1
    PLAYER_FIELD_MAINHAND_EXPERTISE = 2241, // SIZE:1
    PLAYER_FIELD_OFFHAND_EXPERTISE = 2242, // SIZE:1
    PLAYER_FIELD_RANGED_EXPERTISE = 2243, // SIZE:1
    PLAYER_FIELD_COMBAT_RATING_EXPERTISE = 2244, // SIZE:1
    PLAYER_FIELD_BLOCK_PERCENTAGE = 2245, // SIZE:1
    PLAYER_FIELD_DODGE_PERCENTAGE = 2246, // SIZE:1
    PLAYER_FIELD_PARRY_PERCENTAGE = 2247, // SIZE:1
    PLAYER_FIELD_CRIT_PERCENTAGE = 2248, // SIZE:1
    PLAYER_FIELD_RANGED_CRIT_PERCENTAGE = 2249, // SIZE:1
    PLAYER_FIELD_OFFHAND_CRIT_PERCENTAGE = 2250, // SIZE:1
    PLAYER_FIELD_SPELL_CRIT_PERCENTAGE = 2251, // SIZE:7
    PLAYER_FIELD_SHIELD_BLOCK = 2258, // SIZE:1
    PLAYER_FIELD_SHIELD_BLOCK_CRIT_PERCENTAGE = 2259, // SIZE:1
    PLAYER_FIELD_MASTERY = 2260, // SIZE:1
    PLAYER_FIELD_AMPLIFY = 2261, // SIZE:1
    PLAYER_FIELD_MULTISTRIKE = 2262, // SIZE:1
    PLAYER_FIELD_MULTISTRIKE_EFFECT = 2263, // SIZE:1
    PLAYER_FIELD_READINESS = 2264, // SIZE:1
    PLAYER_FIELD_SPEED = 2265, // SIZE:1
    PLAYER_FIELD_LIFESTEAL = 2266, // SIZE:1
    PLAYER_FIELD_AVOIDANCE = 2267, // SIZE:1
    PLAYER_FIELD_STURDINESS = 2268, // SIZE:1
    PLAYER_FIELD_CLEAVE = 2269, // SIZE:1
    PLAYER_FIELD_VERSATILITY = 2270, // SIZE:1
    PLAYER_FIELD_VERSATILITY_BONUS = 2271, // SIZE:1
    PLAYER_FIELD_PVP_POWER_DAMAGE = 2272, // SIZE:1
    PLAYER_FIELD_PVP_POWER_HEALING = 2273, // SIZE:1
    PLAYER_FIELD_EXPLORED_ZONES = 2274, // SIZE:200
    PLAYER_FIELD_REST_STATE_BONUS_POOL = 2474, // SIZE:1
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS = 2475, // SIZE:7
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = 2482, // SIZE:7
    PLAYER_FIELD_MOD_DAMAGE_DONE_PERCENT = 2489, // SIZE:7
    PLAYER_FIELD_MOD_HEALING_DONE_POS = 2496, // SIZE:1
    PLAYER_FIELD_MOD_HEALING_PERCENT = 2497, // SIZE:1
    PLAYER_FIELD_MOD_HEALING_DONE_PERCENT = 2498, // SIZE:1
    PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT = 2499, // SIZE:1
    PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS = 2500, // SIZE:3
    PLAYER_FIELD_WEAPON_ATK_SPEED_MULTIPLIERS = 2503, // SIZE:3
    PLAYER_FIELD_MOD_SPELL_POWER_PERCENT = 2506, // SIZE:1
    PLAYER_FIELD_MOD_RESILIENCE_PERCENT = 2507, // SIZE:1
    PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_APPERCENT = 2508, // SIZE:1
    PLAYER_FIELD_OVERRIDE_APBY_SPELL_POWER_PERCENT = 2509, // SIZE:1
    PLAYER_FIELD_MOD_TARGET_RESISTANCE = 2510, // SIZE:1
    PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = 2511, // SIZE:1
    PLAYER_FIELD_LOCAL_FLAGS = 2512, // SIZE:1
    PLAYER_FIELD_LIFETIME_MAX_RANK = 2513, // SIZE:1
    PLAYER_FIELD_SELF_RES_SPELL = 2514, // SIZE:1
    PLAYER_FIELD_PVP_MEDALS = 2515, // SIZE:1
    PLAYER_FIELD_BUYBACK_PRICE = 2516, // SIZE:12
    PLAYER_FIELD_BUYBACK_TIMESTAMP = 2528, // SIZE:12
    PLAYER_FIELD_YESTERDAY_HONORABLE_KILLS = 2540, // SIZE:1
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS = 2541, // SIZE:1
    PLAYER_FIELD_WATCHED_FACTION_INDEX = 2542, // SIZE:1
    PLAYER_FIELD_COMBAT_RATINGS = 2543, // SIZE:32
    PLAYER_FIELD_PVP_INFO = 2575, // SIZE:36
    PLAYER_FIELD_MAX_LEVEL = 2611, // SIZE:1
    PLAYER_FIELD_RUNE_REGEN = 2612, // SIZE:4
    PLAYER_FIELD_NO_REAGENT_COST_MASK = 2616, // SIZE:4
    PLAYER_FIELD_GLYPH_SLOTS = 2620, // SIZE:6
    PLAYER_FIELD_GLYPHS = 2626, // SIZE:6
    PLAYER_FIELD_GLYPH_SLOTS_ENABLED = 2632, // SIZE:1
    PLAYER_FIELD_PET_SPELL_POWER = 2633, // SIZE:1
    PLAYER_FIELD_RESEARCHING = 2634, // SIZE:10
    PLAYER_FIELD_PROFESSION_SKILL_LINE = 2644, // SIZE:2
    PLAYER_FIELD_UI_HIT_MODIFIER = 2646, // SIZE:1
    PLAYER_FIELD_UI_SPELL_HIT_MODIFIER = 2647, // SIZE:1
    PLAYER_FIELD_HOME_REALM_TIME_OFFSET = 2648, // SIZE:1
    PLAYER_FIELD_MOD_PET_HASTE = 2649, // SIZE:1
    PLAYER_FIELD_SUMMONED_BATTLE_PET_GUID = 2650, // SIZE:4
    PLAYER_FIELD_OVERRIDE_SPELLS_ID = 2654, // SIZE:1
    PLAYER_FIELD_LFG_BONUS_FACTION_ID = 2655, // SIZE:1
    PLAYER_FIELD_LOOT_SPEC_ID = 2656, // SIZE:1
    PLAYER_FIELD_OVERRIDE_ZONE_PVPTYPE = 2657, // SIZE:1
    PLAYER_FIELD_ITEM_LEVEL_DELTA = 2658, // SIZE:1
    PLAYER_FIELD_BAG_SLOT_FLAGS = 2659, // SIZE:4
    PLAYER_FIELD_BANK_AUTO_SORT_DISABLED = 2663, // SIZE:1
    PLAYER_FIELD_BANK_BAG_SLOT_AUTO_SORT_DISABLED = 2664, // SIZE:1
    PLAYER_FIELD_INSERT_ITEMS_LEFT_TO_RIGHT = 2665, // SIZE:1
    PLAYER_END = 2666
};
