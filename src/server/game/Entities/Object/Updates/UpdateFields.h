...
enum EPlayerFields
{
    ...
    PLAYER_FIELD_PLAYER_FLAGS = 203, // SIZE:1
    PLAYER_FIELD_PLAYER_FLAGS_EX = 204, // SIZE:1
    PLAYER_FIELD_GUILD_RANK_ID = 205, // SIZE:1
    PLAYER_FIELD_GUILD_DELETE_DATE = 206, // SIZE:1
    PLAYER_FIELD_GUILD_LEVEL = 207, // SIZE:1
    PLAYER_FIELD_HAIR_COLOR_ID = 208, // SIZE:1
    PLAYER_FIELD_REST_STATE = 209, // SIZE:1
    PLAYER_FIELD_ARENA_FACTION = 210, // SIZE:1
    PLAYER_FIELD_DUEL_TEAM = 211, // SIZE:1
    PLAYER_FIELD_GUILD_TIME_STAMP = 212, // SIZE:1
    PLAYER_FIELD_QUEST_LOG = 213, // SIZE:750
    PLAYER_FIELD_VISIBLE_ITEMS = 963, // SIZE:57
    PLAYER_FIELD_PLAYER_TITLE = 1020, // SIZE:1
    PLAYER_FIELD_FAKE_INEBRIATION = 1021, // SIZE:1
    PLAYER_FIELD_VIRTUAL_PLAYER_REALM = 1022, // SIZE:1
    PLAYER_FIELD_CURRENT_SPEC_ID = 1023, // SIZE:1
    PLAYER_FIELD_TAXI_MOUNT_ANIM_KIT_ID = 1024, // SIZE:1
    PLAYER_FIELD_AVG_ITEM_LEVEL_TOTAL = 1025, // SIZE:1
    PLAYER_FIELD_AVG_ITEM_LEVEL_EQUIPPED = 1026, // SIZE:1
    PLAYER_FIELD_CURRENT_BATTLE_PET_BREED_QUALITY = 1027, // SIZE:1
    PLAYER_FIELD_INV_SLOTS = 1028, // SIZE:736
    PLAYER_FIELD_FARSIGHT_OBJECT = 1764, // SIZE:4
    PLAYER_FIELD_KNOWN_TITLES = 1768, // SIZE:10
    PLAYER_FIELD_COINAGE = 1778, // SIZE:2
    PLAYER_FIELD_XP = 1780, // SIZE:1
    PLAYER_FIELD_NEXT_LEVEL_XP = 1781, // SIZE:1
    PLAYER_FIELD_SKILL = 1782, // SIZE:448
    PLAYER_FIELD_CHARACTER_POINTS = 2230, // SIZE:1
    PLAYER_FIELD_MAX_TALENT_TIERS = 2231, // SIZE:1
    PLAYER_FIELD_TRACK_CREATURE_MASK = 2232, // SIZE:1
    PLAYER_FIELD_TRACK_RESOURCE_MASK = 2233, // SIZE:1
    PLAYER_FIELD_MAINHAND_EXPERTISE = 2234, // SIZE:1
    PLAYER_FIELD_OFFHAND_EXPERTISE = 2235, // SIZE:1
    PLAYER_FIELD_RANGED_EXPERTISE = 2236, // SIZE:1
    PLAYER_FIELD_COMBAT_RATING_EXPERTISE = 2237, // SIZE:1
    PLAYER_FIELD_BLOCK_PERCENTAGE = 2238, // SIZE:1
    PLAYER_FIELD_DODGE_PERCENTAGE = 2239, // SIZE:1
    PLAYER_FIELD_PARRY_PERCENTAGE = 2240, // SIZE:1
    PLAYER_FIELD_CRIT_PERCENTAGE = 2241, // SIZE:1
    PLAYER_FIELD_RANGED_CRIT_PERCENTAGE = 2242, // SIZE:1
    PLAYER_FIELD_OFFHAND_CRIT_PERCENTAGE = 2243, // SIZE:1
    PLAYER_FIELD_SPELL_CRIT_PERCENTAGE = 2244, // SIZE:7
    PLAYER_FIELD_SHIELD_BLOCK = 2251, // SIZE:1
    PLAYER_FIELD_SHIELD_BLOCK_CRIT_PERCENTAGE = 2252, // SIZE:1
    PLAYER_FIELD_MASTERY = 2253, // SIZE:1
    PLAYER_FIELD_AMPLIFY = 2254, // SIZE:1
    PLAYER_FIELD_MULTISTRIKE = 2255, // SIZE:1
    PLAYER_FIELD_MULTISTRIKE_EFFECT = 2256, // SIZE:1
    PLAYER_FIELD_READINESS = 2257, // SIZE:1
    PLAYER_FIELD_SPEED = 2258, // SIZE:1
    PLAYER_FIELD_LIFESTEAL = 2259, // SIZE:1
    PLAYER_FIELD_AVOIDANCE = 2260, // SIZE:1
    PLAYER_FIELD_STURDINESS = 2261, // SIZE:1
    PLAYER_FIELD_CLEAVE = 2262, // SIZE:1
    PLAYER_FIELD_VERSATILITY = 2263, // SIZE:1
    PLAYER_FIELD_VERSATILITY_BONUS = 2264, // SIZE:1
    PLAYER_FIELD_PVP_POWER_DAMAGE = 2265, // SIZE:1
    PLAYER_FIELD_PVP_POWER_HEALING = 2266, // SIZE:1
    PLAYER_FIELD_EXPLORED_ZONES = 2267, // SIZE:200
    PLAYER_FIELD_REST_STATE_BONUS_POOL = 2467, // SIZE:1
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS = 2468, // SIZE:7
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = 2475, // SIZE:7
    PLAYER_FIELD_MOD_DAMAGE_DONE_PERCENT = 2482, // SIZE:7
    PLAYER_FIELD_MOD_HEALING_DONE_POS = 2489, // SIZE:1
    PLAYER_FIELD_MOD_HEALING_PERCENT = 2490, // SIZE:1
    PLAYER_FIELD_MOD_HEALING_DONE_PERCENT = 2491, // SIZE:1
    PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT = 2492, // SIZE:1
    PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS = 2493, // SIZE:3
    PLAYER_FIELD_WEAPON_ATK_SPEED_MULTIPLIERS = 2496, // SIZE:3
    PLAYER_FIELD_MOD_SPELL_POWER_PERCENT = 2499, // SIZE:1
    PLAYER_FIELD_MOD_RESILIENCE_PERCENT = 2500, // SIZE:1
    PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_APPERCENT = 2501, // SIZE:1
    PLAYER_FIELD_OVERRIDE_APBY_SPELL_POWER_PERCENT = 2502, // SIZE:1
    PLAYER_FIELD_MOD_TARGET_RESISTANCE = 2503, // SIZE:1
    PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = 2504, // SIZE:1
    PLAYER_FIELD_LOCAL_FLAGS = 2505, // SIZE:1
    PLAYER_FIELD_LIFETIME_MAX_RANK = 2506, // SIZE:1
    PLAYER_FIELD_SELF_RES_SPELL = 2507, // SIZE:1
    PLAYER_FIELD_PVP_MEDALS = 2508, // SIZE:1
    PLAYER_FIELD_BUYBACK_PRICE = 2509, // SIZE:12
    PLAYER_FIELD_BUYBACK_TIMESTAMP = 2521, // SIZE:12
    PLAYER_FIELD_YESTERDAY_HONORABLE_KILLS = 2533, // SIZE:1
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS = 2534, // SIZE:1
    PLAYER_FIELD_WATCHED_FACTION_INDEX = 2535, // SIZE:1
    PLAYER_FIELD_COMBAT_RATINGS = 2536, // SIZE:32
    PLAYER_FIELD_PVP_INFO = 2568, // SIZE:36
    PLAYER_FIELD_MAX_LEVEL = 2604, // SIZE:1
    PLAYER_FIELD_RUNE_REGEN = 2605, // SIZE:4
    PLAYER_FIELD_NO_REAGENT_COST_MASK = 2609, // SIZE:4
    PLAYER_FIELD_GLYPH_SLOTS = 2613, // SIZE:6
    PLAYER_FIELD_GLYPHS = 2619, // SIZE:6
    PLAYER_FIELD_GLYPH_SLOTS_ENABLED = 2625, // SIZE:1
    PLAYER_FIELD_PET_SPELL_POWER = 2626, // SIZE:1
    PLAYER_FIELD_RESEARCHING = 2627, // SIZE:10
    PLAYER_FIELD_PROFESSION_SKILL_LINE = 2637, // SIZE:2
    PLAYER_FIELD_UI_HIT_MODIFIER = 2639, // SIZE:1
    PLAYER_FIELD_UI_SPELL_HIT_MODIFIER = 2640, // SIZE:1
    PLAYER_FIELD_HOME_REALM_TIME_OFFSET = 2641, // SIZE:1
    PLAYER_FIELD_MOD_PET_HASTE = 2642, // SIZE:1
    PLAYER_FIELD_SUMMONED_BATTLE_PET_GUID = 2643, // SIZE:4
    PLAYER_FIELD_OVERRIDE_SPELLS_ID = 2647, // SIZE:1
    PLAYER_FIELD_LFG_BONUS_FACTION_ID = 2648, // SIZE:1
    PLAYER_FIELD_LOOT_SPEC_ID = 2649, // SIZE:1
    PLAYER_FIELD_OVERRIDE_ZONE_PVPTYPE = 2650, // SIZE:1
    PLAYER_FIELD_ITEM_LEVEL_DELTA = 2651, // SIZE:1
    PLAYER_FIELD_BAG_SLOT_FLAGS = 2652, // SIZE:4
    PLAYER_FIELD_BANK_AUTO_SORT_DISABLED = 2656, // SIZE:1
    PLAYER_FIELD_BANK_BAG_SLOT_AUTO_SORT_DISABLED = 2657, // SIZE:1
    PLAYER_FIELD_INSERT_ITEMS_LEFT_TO_RIGHT = 2658, // SIZE:1
    PLAYER_END = 2659
};
