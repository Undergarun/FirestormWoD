...
{
    uint32 l_NameLen, l_CommentLen, l_VoiceChatLen, l_Entry;
...
void WorldSession::BuildLfgListJoinRequest(WorldPacket* p_Data, LFGListEntry const* p_Entry)
{
    ...
    *p_Data << uint32(p_Entry->m_ActivityID);
