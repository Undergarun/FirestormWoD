...
namespace MS { namespace Garrison 
{
    ...
    BuildingManager::BuildingManager()
    {
        ...
        m_AllowedBluePrints.push_back(Buildings::GemBoutique_GemBoutique_Level3);
        ...
        m_AllowedBluePrints.push_back(Buildings::TailoringEmporium_TailoringEmporium_Level3);
