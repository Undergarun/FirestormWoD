...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_SEL_PETBATTLE_BATTLESLOT_ACCOUNT,
    LOGIN_SEL_PETBATTLE_TEAM,
    LOGIN_REP_PETBATTLE,
    LOGIN_INS_PETBATTLE,
    LOGIN_UPD_PETBATTLE_TOGGLE_FLAGS,
    LOGIN_UPD_PETBATTLE_RENAME,
    LOGIN_SEL_PETBATTLE_UNSET_BATTLESLOT,
    LOGIN_SEL_PETBATTLE_SET_BATTLESLOT,
    LOGIN_SEL_PETBATTLE_REPLACE_BATTLESLOT,
    LOGIN_HEAL_ALL_PETBATTLE_ACCOUNT,
    LOGIN_SEL_PETBATTLE_COUNT_BATTLE_SPECIES,
