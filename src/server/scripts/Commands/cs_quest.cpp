...
class quest_commandscript: public MS::Game::Scripting::Interfaces::CommandScript
{
public:
    quest_commandscript() : MS::Game::Scripting::Interfaces::CommandScript("quest_commandscript") { }
