...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            cInfo->DifficultyEntry[3]  = fields[3].GetUInt32();
            cInfo->DifficultyEntry[4]  = fields[4].GetUInt32();
            cInfo->DifficultyEntry[5]  = fields[5].GetUInt32();
            cInfo->DifficultyEntry[6]  = fields[6].GetUInt32();
            cInfo->DifficultyEntry[7]  = fields[7].GetUInt32();
            cInfo->DifficultyEntry[8]  = fields[8].GetUInt32();
            cInfo->DifficultyEntry[9]  = fields[9].GetUInt32();
            cInfo->DifficultyEntry[10] = fields[10].GetUInt32();
            cInfo->DifficultyEntry[11] = fields[11].GetUInt32();
            cInfo->DifficultyEntry[12] = fields[12].GetUInt32();
            cInfo->DifficultyEntry[13] = fields[13].GetUInt32();
            cInfo->DifficultyEntry[14] = fields[14].GetUInt32();

            cInfo->KillCredit[0]       = fields[15].GetUInt32();
            cInfo->KillCredit[1]       = fields[16].GetUInt32();
            cInfo->Modelid1            = fields[17].GetUInt32();
            cInfo->Modelid2            = fields[18].GetUInt32();
            cInfo->Modelid3            = fields[19].GetUInt32();
            cInfo->Modelid4            = fields[20].GetUInt32();
            cInfo->Name                = fields[21].GetString();
            cInfo->SubName             = fields[22].GetString();
            cInfo->IconName            = fields[23].GetString();
            cInfo->GossipMenuId        = fields[24].GetUInt32();
            cInfo->minlevel            = fields[25].GetUInt8();
            cInfo->maxlevel            = fields[26].GetUInt8();
            cInfo->expansion           = fields[27].GetUInt16();
            cInfo->expansionUnknown    = fields[28].GetUInt16();
            cInfo->faction_A           = fields[29].GetUInt16();
            cInfo->faction_H           = fields[30].GetUInt16();
            cInfo->npcflag             = fields[31].GetUInt32();
            cInfo->npcflag2            = fields[32].GetUInt32();
            cInfo->speed_walk          = fields[33].GetFloat();
            cInfo->speed_run           = fields[34].GetFloat();
            cInfo->speed_fly           = fields[35].GetFloat();
            cInfo->scale               = fields[36].GetFloat();
            cInfo->rank                = fields[37].GetUInt8();
            cInfo->mindmg              = fields[38].GetFloat();
            cInfo->maxdmg              = fields[39].GetFloat();
            cInfo->dmgschool           = fields[40].GetUInt8();
            cInfo->attackpower         = fields[41].GetUInt32();
            cInfo->dmg_multiplier      = fields[42].GetFloat();
            cInfo->baseattacktime      = fields[43].GetUInt32();
            cInfo->rangeattacktime     = fields[44].GetUInt32();
            cInfo->unit_class          = fields[45].GetUInt8();
            cInfo->unit_flags          = fields[46].GetUInt32();
            cInfo->unit_flags2         = fields[47].GetUInt32();
            cInfo->dynamicflags        = fields[48].GetUInt32();
            cInfo->family              = fields[49].GetUInt8();
            cInfo->trainer_type        = fields[50].GetUInt8();
            cInfo->trainer_spell       = fields[51].GetUInt32();
            cInfo->trainer_class       = fields[52].GetUInt8();
            cInfo->trainer_race        = fields[53].GetUInt8();
            cInfo->minrangedmg         = fields[54].GetFloat();
            cInfo->maxrangedmg         = fields[55].GetFloat();
            cInfo->rangedattackpower   = fields[56].GetUInt16();
            cInfo->type                = fields[57].GetUInt8();
            cInfo->type_flags          = fields[58].GetUInt32();
            cInfo->type_flags2         = fields[59].GetUInt32();
            cInfo->lootid              = fields[60].GetUInt32();
            cInfo->pickpocketLootId    = fields[61].GetUInt32();
            cInfo->SkinLootId          = fields[62].GetUInt32();

            for (uint8 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; ++i)
                cInfo->resistance[i] = fields[63 + i - 1].GetUInt16();

            cInfo->spells[0]           = fields[69].GetUInt32();
            cInfo->spells[1]           = fields[70].GetUInt32();
            cInfo->spells[2]           = fields[71].GetUInt32();
            cInfo->spells[3]           = fields[72].GetUInt32();
            cInfo->spells[4]           = fields[73].GetUInt32();
            cInfo->spells[5]           = fields[74].GetUInt32();
            cInfo->spells[6]           = fields[75].GetUInt32();
            cInfo->spells[7]           = fields[76].GetUInt32();
            cInfo->PetSpellDataId      = fields[77].GetUInt32();
            cInfo->VehicleId           = fields[78].GetUInt32();
            cInfo->mingold             = fields[79].GetUInt32();
            cInfo->maxgold             = fields[80].GetUInt32();
            cInfo->AIName              = fields[81].GetString();
            cInfo->MovementType        = fields[82].GetUInt8();
            cInfo->InhabitType         = fields[83].GetUInt8();
            cInfo->HoverHeight         = fields[84].GetFloat();
            cInfo->ModHealth           = fields[85].GetFloat();
            cInfo->ModMana             = fields[86].GetFloat();
            cInfo->ModManaExtra        = fields[87].GetFloat();
            cInfo->ModArmor            = fields[88].GetFloat();
            cInfo->RacialLeader        = fields[89].GetBool();
            cInfo->questItems[0]       = fields[90].GetUInt32();
            cInfo->questItems[1]       = fields[91].GetUInt32();
            cInfo->questItems[2]       = fields[92].GetUInt32();
            cInfo->questItems[3]       = fields[93].GetUInt32();
            cInfo->questItems[4]       = fields[94].GetUInt32();
            cInfo->questItems[5]       = fields[95].GetUInt32();
            cInfo->movementId          = fields[96].GetUInt32();
            cInfo->RegenHealth         = fields[97].GetBool();
            cInfo->equipmentId         = fields[98].GetUInt32();
            cInfo->MechanicImmuneMask  = fields[99].GetUInt32();
            cInfo->flags_extra         = fields[100].GetUInt32();
            cInfo->ScriptID            = sObjectMgr->GetScriptId(fields[101].GetCString());
