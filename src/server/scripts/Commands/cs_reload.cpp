...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            cInfo->lootid              = fields[58].GetUInt32();
            cInfo->pickpocketLootId    = fields[59].GetUInt32();
            cInfo->SkinLootId          = fields[60].GetUInt32();

            for (uint8 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; ++i)
                cInfo->resistance[i] = fields[61 + i - 1].GetUInt16();

            cInfo->spells[0]           = fields[67].GetUInt32();
            cInfo->spells[1]           = fields[68].GetUInt32();
            cInfo->spells[2]           = fields[69].GetUInt32();
            cInfo->spells[3]           = fields[70].GetUInt32();
            cInfo->spells[4]           = fields[71].GetUInt32();
            cInfo->spells[5]           = fields[72].GetUInt32();
            cInfo->spells[6]           = fields[73].GetUInt32();
            cInfo->spells[7]           = fields[74].GetUInt32();
            cInfo->PetSpellDataId      = fields[75].GetUInt32();
            cInfo->VehicleId           = fields[76].GetUInt32();
            cInfo->mingold             = fields[77].GetUInt32();
            cInfo->maxgold             = fields[78].GetUInt32();
            cInfo->AIName              = fields[79].GetString();
            cInfo->MovementType        = fields[80].GetUInt8();
            cInfo->InhabitType         = fields[81].GetUInt8();
            cInfo->HoverHeight         = fields[82].GetFloat();
            cInfo->ModHealth           = fields[83].GetFloat();
            cInfo->ModMana             = fields[84].GetFloat();
            cInfo->ModManaExtra        = fields[85].GetFloat();
            cInfo->ModArmor            = fields[86].GetFloat();
            cInfo->RacialLeader        = fields[87].GetBool();
            cInfo->questItems[0]       = fields[88].GetUInt32();
            cInfo->questItems[1]       = fields[89].GetUInt32();
            cInfo->questItems[2]       = fields[90].GetUInt32();
            cInfo->questItems[3]       = fields[91].GetUInt32();
            cInfo->questItems[4]       = fields[92].GetUInt32();
            cInfo->questItems[5]       = fields[93].GetUInt32();
            cInfo->movementId          = fields[94].GetUInt32();
            cInfo->RegenHealth         = fields[95].GetBool();
            cInfo->equipmentId         = fields[96].GetUInt32();
            cInfo->MechanicImmuneMask  = fields[97].GetUInt32();
            cInfo->flags_extra         = fields[98].GetUInt32();
            cInfo->ScriptID            = sObjectMgr->GetScriptId(fields[99].GetCString());
