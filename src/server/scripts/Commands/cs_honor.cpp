...
class honor_commandscript: public MS::Game::Scripting::Interfaces::CommandScript
{
public:
    honor_commandscript() : MS::Game::Scripting::Interfaces::CommandScript("honor_commandscript") { }
