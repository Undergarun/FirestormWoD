...
class instance_naxxramas : public MS::Game::Scripting::Interfaces::InstanceMapScript
{
public:
    instance_naxxramas() : MS::Game::Scripting::Interfaces::InstanceMapScript("instance_naxxramas", 533) { }
        ...
        bool CheckAchievementCriteriaMeet(uint32 criteria_id, Player const* /*source*/, Unit const* /*target = NULL*/, uint32 /*miscvalue1 = 0*/)
        {
            switch (criteria_id)
            {
                case 7600:  // Criteria for achievement 2176: And They Would All Go Down Together 15sec of each other 10-man
                    if (Difficulty(instance->GetSpawnMode()) == LEGACY_MAN10_DIFFICULTY && (maxHorsemenDiedTime - minHorsemenDiedTime) < 15)
                        return true;
                    return false;
                case 7601:  // Criteria for achievement 2177: And They Would All Go Down Together 15sec of each other 25-man
                    if (Difficulty(instance->GetSpawnMode()) == LEGACY_MAN25_DIFFICULTY && (maxHorsemenDiedTime - minHorsemenDiedTime) < 15)
                        return true;
                    return false;
