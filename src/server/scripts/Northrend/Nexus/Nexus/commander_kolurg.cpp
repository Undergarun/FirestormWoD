...
class boss_commander_kolurg : public MS::Game::Scripting::Interfaces::CreatureScript
{
public:
    boss_commander_kolurg() : MS::Game::Scripting::Interfaces::CreatureScript("boss_commander_kolurg") { }
