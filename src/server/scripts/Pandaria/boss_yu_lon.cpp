...
class world_boss_yu_lon : public MS::Game::Scripting::Interfaces::CreatureScript
{
    public:
        world_boss_yu_lon() : MS::Game::Scripting::Interfaces::CreatureScript("world_boss_yu_lon") { }
