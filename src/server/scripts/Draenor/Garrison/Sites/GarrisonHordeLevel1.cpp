...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    void InstanceScript_GarrisonHordeLevel1::OnCreatureCreate(Creature * p_Creature)
    {

    }
    /// When a game object is created
    /// @p_Gameobject : Created game object instance
    void InstanceScript_GarrisonHordeLevel1::OnGameObjectCreate(GameObject * p_Gameobject)
    {
    ...
    void InstanceScript_GarrisonHordeLevel1::OnMissionStart(uint32 p_MissionID, std::vector<uint32> p_Followers)
    {

    }
    /// When a construction start
    /// @p_BuildingID : Purchased building ID
    void InstanceScript_GarrisonHordeLevel1::OnPurchaseBuilding(uint32 p_BuildingID)
    {
