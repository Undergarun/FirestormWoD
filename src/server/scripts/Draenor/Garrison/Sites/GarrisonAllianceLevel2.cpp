...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    void InstanceScript_GarrisonAllianceLevel2::OnCreatureCreate(Creature * p_Creature)
    {

    }
    /// When a game object is created
    /// @p_Gameobject : Created game object instance
    void InstanceScript_GarrisonAllianceLevel2::OnGameObjectCreate(GameObject * p_Gameobject)
    {
