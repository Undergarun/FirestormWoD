...
namespace MS { namespace Garrison
{
    ...
    /*
    /// This coords correspond to wrong PlotInstanceID (63), cant find why, wrong space analysis
    { 64.5974f, -42.5031f, -29.7672f, 4.5715f },
    { -29.6266f, 10.8310f, -56.0146f, 5.1409f },
    */
    ...
    std::vector<SequencePosition> g_PlaceholderAllyVector;
            ...
            if (l_GarrisonMgr->HasRequiredFollowerAssignedAbility(p_PlotInstanceID))
            {
                ...
                switch (GetBuildingID())
                {
                    ...
                    case Building::ID::LunarfallExcavation_FrostwallMines_Level3:
                        if (Creature* l_Creature = SummonRelativeCreature(l_GarrFollEntry->CreatureID[1], 28.5000f, -63.6978f, 30.5292f, 4.7543f, TEMPSUMMON_MANUAL_DESPAWN))
                        {
