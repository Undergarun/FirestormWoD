...
namespace MS { namespace Garrison
{
    ...
    class npc_PeterKearie : public CreatureScript
    {
        public:
            ...
            /// Creature AI
            struct npc_PeterKearieAI : public GarrisonNPCAI
            {
                /// Constructor
                ...
                virtual void OnSetBuildingID(uint32 p_BuildingID) override
                {
                    ...
                    {
                        case 1:
                            (npc_PeterKearieAIData::FnLevel1)(this, me);
                            break;

                        case 2:
                            (npc_PeterKearieAIData::FnLevel2)(this, me);
                            break;

                        case 3:
                            (npc_PeterKearieAIData::FnLevel3)(this, me);
                            break;
