...
namespace MS { namespace Garrison
{
    ...
    class npc_HelaynWhent : public CreatureScript
    {
        public:
            /// Constructor
            npc_HelaynWhent();
            ...
            /// Creature AI
            struct npc_HelaynWhentAI : public GarrisonNPCAI
            {
                /// Constructor
                npc_HelaynWhentAI(Creature* p_Creature);
                ...
                virtual void OnSetBuildingID(uint32 p_BuildingID) override
                {
                    ...
                    {
                        case 1:
                            (npc_HelaynWhentAIData::FnLevel1)(this, me);
                            break;

                        case 2:
                            (npc_HelaynWhentAIData::FnLevel2)(this, me);
                            break;

                        case 3:
                            (npc_HelaynWhentAIData::FnLevel3)(this, me);
                            break;
