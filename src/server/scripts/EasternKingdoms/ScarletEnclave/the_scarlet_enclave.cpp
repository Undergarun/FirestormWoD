...
class npc_valkyr_battle_maiden : public MS::Game::Scripting::Interfaces::CreatureScript
{
public:
    npc_valkyr_battle_maiden() : MS::Game::Scripting::Interfaces::CreatureScript("npc_valkyr_battle_maiden") { }
