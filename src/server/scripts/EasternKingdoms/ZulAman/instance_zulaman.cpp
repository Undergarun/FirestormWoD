...
class instance_zulaman : public MS::Game::Scripting::Interfaces::InstanceMapScript
{
    public:
        instance_zulaman() : MS::Game::Scripting::Interfaces::InstanceMapScript("instance_zulaman", 568){}
