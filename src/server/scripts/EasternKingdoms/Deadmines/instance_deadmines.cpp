...
class instance_deadmines : public MS::Game::Scripting::Interfaces::InstanceMapScript
{
    public:
        instance_deadmines() : MS::Game::Scripting::Interfaces::InstanceMapScript("instance_deadmines", 36) {}
