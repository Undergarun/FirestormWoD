    ...
    public:
        ...
        class spell_pri_cascade_trigger_holy_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                ...
                if (l_FriendlyUnitListTemp.size() > (uint32)l_CascadeSpell->Effects[EFFECT_1].BasePoints)
    ...
    public:
        ...
        class spell_pri_cascade_trigger_shadow_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                ...
                if (l_UnFriendlyUnitListTemp.size() > (uint32)l_CascadeSpell->Effects[EFFECT_1].BasePoints)
